...
#
# CONFIG_USER_MRVL_UNIMAC is not set
CONFIG_USER_MRVL_RGCFG=y
# CONFIG_USER_MRVL_MVWLAN is not set
CONFIG_USER_MRVL_AP_DAEMON=y
# CONFIG_USER_MRVL_AP_MFG_DAEMON is not set
# CONFIG_USER_GPIO is not set
