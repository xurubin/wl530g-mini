...
<td class="content_desc_td" colspan="2" width="614">
              ...
              <p style="margin-top: 7">
                    "새로운 펌웨어 파일"에서 다운로드하는 파일의 경로와 이름을 지정합니다.
              		...
              		<li>
              <p style="margin-top: 7">
                     "업로드"를 클릭하여 파일을 WL520g로 업로드 합니다. 약 10초 정도 소요됩니다.
              </li>
              <li>
              <p style="margin-top: 7">
                    정확한 펌웨어 파일을 받은 후 WL520g 가 업그레이드 과정을 자동으로 시작합니다. 잠시 후 업그레이드 과정이 끝나고 시스템이 재부팅됩니다.
 	      </li>
              </ol>
</td>
</tr>
...
<td class="content_desc_td" colspan="2" width="614">
	             <b>참고:</b>
                     <ol>
                     	...
                     	<li>업그레이드 과정이 실패하면 WL520g가 자동으로 비상모드 상태가 됩니다. WL520g의 앞에 위치한 LED 표시등이 그러한 상황을 알려 줍니다. 시스템 복구를 하려면 펌웨어 복구 유틸리티를 사용합니다.</li>
                     </ol>
</td>
</tr>
</table>
