...
<tr>
<td class="content_desc_td" colspan="2" height="50">
WL520g는 WAN 포트를 통해 여러 종류의 인터넷 연결방식을 지원합니다. 원하는 연결유형을 선택하십시오. 인터넷 연결 전에는 WL520g의 WAN 포트가 DSL 또는 케이블 모뎀에 연결되었는지 확인하십시오.</td>
</tr>
<tr> 
...
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('본 영역에서 WL520g의 호스트 이름을 부여할 수 있습니다. ISP가 보통 요구하는 사항입니다.', LEFT);" onMouseOut="return nd();">호스트 이름:</td><td class="content_input_td"><input type="text" maxlength="32" size="32" name="wan_hostname" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hostname"); %>"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('본 영역에서 인터넷 연결에 필요한 WL520g의 MAC 주소를 부여할 수 있습니다. ISP가 보통 요구하는 사항입니다.', LEFT);" onMouseOut="return nd();">MAC 주소:</td><td class="content_input_td"><input type="text" maxlength="12" size="12" name="wan_hwaddr_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hwaddr_x"); %>" onBlur="return validate_hwaddr(this)" onKeyPress="return is_hwaddr()"></td>
</tr>
<tr>
...
<tr>
<td class="content_desc_td" colspan="2" height="50">WAN포트를 통한 인터넷 연결에 필요한 WL520g의 TCP/IP 설정을 합니다.</td>
</tr>
<tr>
