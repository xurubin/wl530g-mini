...
<tr>
<td class="content_desc_td" colspan="2">포트 트리거 기능은 TCP 또는 UDP 포트를 열어 WL520g에 연결된 컴퓨터와 통신을 할 수 있도록 합니다. 이는 트리거 포트와 수신 포트를 정하는 것으로서 가능하게 됩니다. 트리거 포트가 탐지되면 정하여진 수신포트번호들에 대한 인바운드 패킷이 사용자의 컴퓨터로 제한됩니다.
         </td>
</tr>
<tr>
