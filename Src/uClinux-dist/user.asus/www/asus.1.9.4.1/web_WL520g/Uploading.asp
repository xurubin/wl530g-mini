  ...
  <tr bgcolor="#CCCCCC"> 
    <td width="666" height="125"> 
      <table width="660" height="125" cellpadding="2" cellspacing="0" border="0">
        <tbody> 
        <tr> 
          <td bgcolor="#FF0000" height="50" width="652"><b><font size="5" face="Arial" color="#FFFFFF">설정 파일 업로드중!</font></b></td>
        </tr>
        <tr> 
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial">시스템 업그레이드중! WL520g 설정 홈페이지 화면이 다시 나타날 때까지 기다리십시오!</font></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial"> 
            <font color="#FF0000"><b>Note: 약 30초 정도 소요됩니다.</b></font></font></td>
        </tr>
        </tbody> 
      </table>
    </td>
