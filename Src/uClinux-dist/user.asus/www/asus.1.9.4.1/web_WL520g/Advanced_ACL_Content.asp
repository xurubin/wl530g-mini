...
<tr>
<td class="content_desc_td" colspan="2">접근 컨트롤로 어떤 무선 스테이션으로부터의 접근을 블로킹하거나 어떤 무선 스테이션으로 부터만의 접근을 바이패스 할 수 있습니다. 수락모드에서는 WL520g는 컨트롤 목록의 MAC주소를 가진 스테이션으로 부터의 무선접근만을 허락할 수 있습니다. 거절모드에서는 WL520g는 컨트롤 목록의 MAC주소를 가진 스테이션으로 부터의 무선접근을 허락하지 않을 수 있습니다.
         </td>
</tr>
<tr>
