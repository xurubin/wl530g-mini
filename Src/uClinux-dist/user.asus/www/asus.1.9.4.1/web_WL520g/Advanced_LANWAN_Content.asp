...
<tr>
<td class="content_header_td" onMouseOver="return overlib('비활성화를 선택하면 WAN 포트를 비활성화 하고 AP로 WL520g를 설정합니다. 활성화를 선택하면 ZVMODELV를 NAT 기능이 있는 라우터로 설정합니다. 자동을 선택하면 부팅동안 이더넷 케이블이 WAN포트에 연결되어 있는 경우 ZVMODELV를 라우터로 설정합니다.', LEFT);" onMouseOut="return nd();">WAN 모드:
