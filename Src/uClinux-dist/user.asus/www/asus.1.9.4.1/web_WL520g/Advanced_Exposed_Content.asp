...
<td class="content_section_header_td" colspan="2">특수 어플리케이션
            </td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">일부의 어플리케이션은 NAT 특수 핸들러를 요구합니다. 사용하려면 파라미터를 작성하십시오. 특수 핸들러는 기본설정에서 사용하지 않도록 되어 있습니다.
         </td>
</tr>
<tr>
<td class="content_header_td">스타크래프트(Battle.Net)
