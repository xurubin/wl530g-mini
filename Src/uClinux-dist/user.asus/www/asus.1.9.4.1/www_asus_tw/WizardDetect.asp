  ...
  <tr bgcolor="#FFFFFF"> 
    <td width="420" height="125"> 
      <table width="420" height="125" border="0" cellpadding="0" cellspacing="0" border="0">
        <tbody> 
        <tr> 
          <td bgcolor="#FFFFFF" height="50" colspan="2"><b><font size="5" face="Arial" color="#FF0000">網際網路連線狀態</font></b></td>
        </tr>
        <tr>
	   <td height="30"><font face="Arial" color="#000000">類型</font></td>
	...
	<tr>
	   <td height="30"><font face="Arial" color="#000000">狀態:</font></td>
