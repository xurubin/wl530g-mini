...
<td class="content_header_td_title" colspan="2">無線防火牆 - 基本組態</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">「無線防火牆」（Wireless Firewall）讓您可以建立起一分離式無線本地網路。而所有來自此網路所管理的客戶端（clients）的封包將受到您設定的過濾程式規則所控制。
         <div align="center">
<img name="WirelessFirewall_img" src="graph/wf_none.gif"></div>
</td>
</tr>
<tr>
<td class="content_header_td">啟用無線防火牆？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出將會接受「無線防火牆」所控制的裝置。', LEFT);" onMouseOut="return nd();">應用裝置：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一ZVMODELVZ的IP位址與您在此分離式無線本地網路中所見相同。', LEFT);" onMouseOut="return nd();">IP位址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一ZVMODELVZ的「子網路遮罩」與您在此分離式無線本地網路中所見相同。', LEFT);" onMouseOut="return nd();">子網路遮罩：
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
</table>
</td>
