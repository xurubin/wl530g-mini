...
<td class="content_header_td_title" colspan="2">무선 방화벽 - DHCP 서버</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">ZVMODELVZ는 무선 방화벽이 활성화되어 있는 경우 최대 253개의 무선 네트워크 IP 주소를 지원합니다. 로컬 머신의 IP주소는 네트워크 관리자로 부터 수동 할당받거나 DHCP 서버가 활성화 된 경우 ZVMODELVZ로 부터 자동 부여받을 수 있습니다.
         </td>
</tr>
<tr>
<td class="content_header_td">DHCP서버를 활성화하겠습니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 DHCP서버의 IP 주소를 요청하는 무선 클라이언트들에게 제공하는 도메인 이름을 나타냅니다.', LEFT);" onMouseOut="return nd();">도메인 이름:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 무선 네트워크의 DHCP서버에 의하여 할당되는 IP 풀의 첫 번째 주소를 나타냅니다.', LEFT);" onMouseOut="return nd();">IP 풀 시작 주소:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 무선 네트워크의 DHCP서버에 의하여 할당되는 IP 풀의 마지막 주소를 나타냅니다.', LEFT);" onMouseOut="return nd();">IP 풀 종료 주소:
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("LANHostConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 현재의 유동 IP주소로 무선 네트워크 사용자에게 허락된 연결시간을 나타냅니다.', LEFT);" onMouseOut="return nd();">리스 시간:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 DHCP서버의 IP 주소를 요청하는 무선 클라이언트들에게 제공하는 도메인 이름을 나타냅니다. 공란으로 두면DNS 요청은 ZVMODELVZ가 처리하게 됩니다.', LEFT);" onMouseOut="return nd();">DNS 서버 1:
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("LANHostConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('WINS는 모든 PC의 인터넷 인터랙션을 관리합니다. WINS서버를 사용하고 있으면 이 곳에 서버의 IP주소를 입력하십시오.', LEFT);" onMouseOut="return nd();">WINS 서버:
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("LANHostConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr class="content_section_header_tr">
...
<td class="content_list_header_td" width="60%" id="DmzManualDHCPList">수동할당 IP 목록
         <input type="hidden" name="DmzManualDHCPCount_0" value="<% nvram_get_x("LANHostConfig", "DmzManualDHCPCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DmzManualDHCPList', 8, ' Add ');" name="DmzManualDHCPList" value="추가" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DmzManualDHCPList', 8, ' Del ');" name="DmzManualDHCPList" value="삭제" size="12">
</div>
</td><td width="5%"></td>
</tr>
