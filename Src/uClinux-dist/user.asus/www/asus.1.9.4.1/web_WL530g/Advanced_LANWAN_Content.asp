...
<tr>
<td class="content_desc_td" colspan="2">WL530g可支援數種連結WAN的連線類型。這些類型可從WAN連線類型旁的下拉式選單中選取。設定欄位會視您是選取那種連線類型而定。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('選擇「停用」，會將WAN通訊埠停用並將WL530g設成是一台AP。選擇「啟用」，會將WL530g設成是一台含有NAT功能的路由器。在開機期間將乙太網路纜線接上WAN通訊埠時，選擇「自動」可將WL530g設成是一台路由器。', LEFT);" onMouseOut="return nd();">WAN模式：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一WL530g的IP位址與您在遠端網路上所見相同。如果您空著不填，WL530g會自動向DHCP伺服器取得IP位址。', LEFT);" onMouseOut="return nd();">IP位址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一WL530g的IP位址與您在遠端網路上所見相同。', LEFT);" onMouseOut="return nd();">子網路遮罩：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此為預設閘道器的IP位址，可使WL530g與遠端網路或主機之間相互連繫。', LEFT);" onMouseOut="return nd();">預設閘道器：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一欄位可顯示WL530g所連繫的DNS的IP位址。', LEFT);" onMouseOut="return nd();">DNS伺服器1：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一欄位可顯示WL530g所連繫的DNS的IP位址。', LEFT);" onMouseOut="return nd();">DNS伺服器2：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可讓您提供WL530g所使用的主機名稱。通常是您ISP業者要求的名稱。', LEFT);" onMouseOut="return nd();">主機名稱：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可讓您提供WL530g連接網際網路所使用的特有網路卡實體位址（MAC Address）。通常是您ISP業者要求的位址。', LEFT);" onMouseOut="return nd();">網路卡實體位址（MAC Address）：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一WL530g的IP位址與您在本地網路中所見相同。預設值是192.168.1.1。', LEFT);" onMouseOut="return nd();">IP位址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一WL530g的子網路遮罩與您在本地網路中所見相同。預設值是255.255.255.0。', LEFT);" onMouseOut="return nd();">子網路遮罩：
