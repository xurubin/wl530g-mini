...
function generateTree()
    ...
    aux1 = appendChild(foldersTree, leafNode("首頁"))  
    aux1 = appendChild(foldersTree, leafNode("快速安裝"))                
    //if (mode == 'AP')
    //{
    ...
    //}       
    	   aux1 = appendChild(foldersTree, leafNode("無線"))
           if (isModel() == 'WL600')    
           {      
              appendChild(aux1, generateDocEntry(0, "介面", "Advanced_Wireless_Content.asp", ""))
           ...
           else
           {
              ...
              appendChild(aux1, generateDocEntry(0, "無線銜接", "Advanced_WMode_Content.asp", ""))              
              appendChild(aux1, generateDocEntry(0, "存取控制", "Advanced_ACL_Content.asp",  ""))
              appendChild(aux1, generateDocEntry(0, "RADIUS設定", "Advanced_WSecurity_Content.asp", ""))             
              appendChild(aux1, generateDocEntry(0, "進階", "Advanced_WAdvanced_Content.asp", ""))              
           }   
    
    if (mode == 'AP')
    {   
    aux1 = appendChild(foldersTree, leafNode("IP組態"))            
           appendChild(aux1, generateDocEntry(0, "區域網路", "Advanced_APLAN_Content.asp", ""))                      
    }       
    else if (mode == 'Gateway')
    {  
    aux1 = appendChild(foldersTree, leafNode("IP組態"))            
           appendChild(aux1, generateDocEntry(0, "基本設定", "Advanced_LANWAN_Content.asp", ""))                                     
           appendChild(aux1, generateDocEntry(0, "PPPoE區段", "Advanced_MultiPPPoE_Content.asp", ""))                                     
           appendChild(aux1, generateDocEntry(0, "DHCP伺服器", "Advanced_DHCP_Content.asp", "")) 
           appendChild(aux1, generateDocEntry(0, "路由", "Advanced_GWStaticRoute_Content.asp", ""))            
           appendChild(aux1, generateDocEntry(0, "其他", "Advanced_DDNS_Content.asp", ""))          

    aux1 = appendChild(foldersTree, leafNode("NAT設定"))   
    	   //if (isModel() == 'WL300')                             
    	   //	appendChild(aux1, generateDocEntry(0, "通訊埠觸發程式",  "Advanced_PortMapping_Content.asp", ""))                  
    	   //else	
    	   appendChild(aux1, generateDocEntry(0, "通訊埠觸發程式",  "Advanced_PortTrigger_Content.asp", ""))            
           appendChild(aux1, generateDocEntry(0, "虛擬伺服器",  "Advanced_VirtualServer_Content.asp", ""))      
           appendChild(aux1, generateDocEntry(0, "虛擬非軍事區",  "Advanced_Exposed_Content.asp", ""))  
            
    aux1 = appendChild(foldersTree, leafNode("防火牆"))    	  
           appendChild(aux1, generateDocEntry(0, "LAN及WAN過濾功能",  "Advanced_Firewall_Content.asp", ""))  
           appendChild(aux1, generateDocEntry(0, " URL過濾功能",  "Advanced_URLFilter_Content.asp", ""))
           //appendChild(aux1, generateDocEntry(0, "WAN & WL530g Filter",  "Advanced_LFirewall_Content.asp", ""))      
           
    if (isModel() != 'WL300')    
    {          
       aux1 = appendChild(foldersTree, leafNode("無線防火牆"))
           appendChild(aux1, generateDocEntry(0, "基本組態",  "Advanced_DMZIP_Content.asp", ""))                           
           appendChild(aux1, generateDocEntry(0, "DHCP伺服器", "Advanced_DMZDHCP_Content.asp", ""))
	   appendChild(aux1, generateDocEntry(0, "WLAN及WAN過濾功能",  "Advanced_DMZDWFilter_Content.asp", ""))                                                                                          
           appendChild(aux1, generateDocEntry(0, "WLAN及WAN過濾功能",  "Advanced_DMZDLFilter_Content.asp", ""))                                                                                                                            
    }       
    ...
    {
    aux1 = appendChild(foldersTree, leafNode("IP組態"))            
           appendChild(aux1, generateDocEntry(0, "基本設定", "Advanced_RLANWAN_Content.asp", ""))                          
           appendChild(aux1, generateDocEntry(0, "DHCP伺服器", "Advanced_RDHCP_Content.asp", "")) 
           appendChild(aux1, generateDocEntry(0, "其他", "Advanced_RMISC_Content.asp", ""))                          
                   
    aux1 = appendChild(foldersTree, leafNode("路由器"))     
           appendChild(aux1, generateDocEntry(0, "靜態路由",  "Advanced_StaticRoute_Content.asp", ""))
           appendChild(aux1, generateDocEntry(0, "動態路由", "Advanced_DynamicRoute_Content.asp", ""))             
    ...
    aux1 = appendChild(foldersTree, leafNode("防火牆"))               
     ...
     {
    	 aux1 = appendChild(foldersTree, leafNode("USB應用程式"))          
           appendChild(aux1, generateDocEntry(0, "FTP伺服器", "Advanced_USBStorage_Content.asp", ""))
           appendChild(aux1, generateDocEntry(0, "網路攝影機", "Advanced_WebCam_Content.asp", ""))
     }      
    
     aux1 = appendChild(foldersTree, leafNode("系統設定"))          
     appendChild(aux1, generateDocEntry(0, "操作模式", "Advanced_OperationMode_Content.asp", "")) 
     appendChild(aux1, generateDocEntry(0, "變更密碼", "Advanced_Password_Content.asp",""))
     appendChild(aux1, generateDocEntry(0, "韌體升級", "Advanced_FirmwareUpgrade_Content.asp", ""))
     appendChild(aux1, generateDocEntry(0, "設定管理", "Advanced_SettingBackup_Content.asp", ""))
     appendChild(aux1, generateDocEntry(0, "原廠預設值", "Advanced_FactoryDefault_Content.asp", ""))
     //appendChild(aux1, generateDocEntry(0, "Printer Setup", "Advanced_PrinterSetup_Content.asp", ""))
    
    if (mode=='AP')
    {
       aux1 = appendChild(foldersTree, leafNode("狀態及記錄"))
           appendChild(aux1,generateDocEntry(0, "狀態", "Main_AStatus_Content.asp", ""))          
           appendChild(aux1,generateDocEntry(0, "無線", "Main_WStatus_Content.asp", ""))
           //appendChild(aux1,generateDocEntry(0, "系統記錄", "Main_LogStatus_Content.asp", ""))
    }
    else if (mode=='Gateway')
    {
       aux1 = appendChild(foldersTree, leafNode("狀態及記錄"))
           appendChild(aux1,generateDocEntry(0, "狀態", "Main_GStatus_Content.asp", ""))          
           appendChild(aux1,generateDocEntry(0, "無線", "Main_WStatus_Content.asp", ""))         
           appendChild(aux1,generateDocEntry(0, "DHCP租約", "Main_DHCPStatus_Content.asp", "")) 
           appendChild(aux1,generateDocEntry(0, "通訊埠轉遞", "Main_IPTStatus_Content.asp", ""))                    
    ...
    {
       aux1 = appendChild(foldersTree, leafNode("狀態及記錄"))
           appendChild(aux1,generateDocEntry(0, "狀態", "Main_RStatus_Content.asp", ""))      
           appendChild(aux1,generateDocEntry(0, "無線", "Main_WStatus_Content.asp", ""))
           appendChild(aux1,generateDocEntry(0, "DHCP租約", "Main_DHCPStatus_Content.asp", ""))            
           appendChild(aux1, generateDocEntry(0, "路由表", "Advanced_RouteStatus_Content.asp", ""))   
           appendChild(aux1,generateDocEntry(0, "系統記錄", "Main_LogStatus_Content.asp", ""))              
...
function clickOnFolderRec(foldersNode, folderName)
{
    ...
    if (foldersNode[3] == folderName)
    {
        ...
        else
        {
            ...
            if (folderName != '快速安裝' && folderName != '首頁')
            {
               foldersNode[0] = 1
               foldersNode[1] = 1     
            }   
