...
<td class="content_header_td_title" colspan="2">IP組態 - 路由</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">本項功能可讓您將路由規則加到WL530g之中。這對於如果您是連接在WL530g之後的數個路由器以便分享同一條網際網路連線上來說，是相當有用的。
         </td>
</tr>
<tr>
<td class="content_header_td">使用靜態路由清單？
...
<td class="content_list_header_td" width="60%" id="GWStatic">靜態路由清單
         <input type="hidden" name="sr_num_x_0" value="<% nvram_get_x("RouterConfig", "sr_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'GWStatic', 6, ' Add ');" name="GWStatic" value="新增" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'GWStatic', 6, ' Del ');" name="GWStatic" value="刪除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'GRouterHelp');" name="GWStatic" value="說明" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<td></td><td class="content_list_field_header_td" colspan="">網路/主機IP	                
           	        </td><td class="content_list_field_header_td" colspan="">網路遮罩	                
           	        </td><td class="content_list_field_header_td" colspan="">閘道器	                
           	        </td><td class="content_list_field_header_td" colspan="">順序	                
           	        </td><td class="content_list_field_header_td" colspan="">介面	                
           	        </td><td></td>
</tr>
<tr>
