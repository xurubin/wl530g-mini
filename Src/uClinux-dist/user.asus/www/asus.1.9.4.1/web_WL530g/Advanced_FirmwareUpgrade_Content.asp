...
<td class="content_desc_td" colspan="2" width="614">
              ...
              <p style="margin-top: 7">
                    請將下載檔案的路徑及名稱指定到「新韌體檔案」中。
              		...
              		<li>
              <p style="margin-top: 7">
                    點選「上傳」將檔案上傳至 WL530g。整個過程需時約10秒鐘。
              </li>
              <li>
              <p style="margin-top: 7">
                    在收到正確的韌體檔案後，WL530g即自動開始升級的過程。整個過程需要一些時間來完成，接著系統將會重新開機。
 	      </li>
              </ol>
</td>
</tr>
...
<td class="content_desc_td" colspan="2" width="614">
	             <b>註：</b>
                     <ol>
                     	...
                     	<li>當升級過程失敗，WL530g會自動進入緊急模式。而WL530g正面上的LED信號即會指示此種情況。請使用光碟上的「韌體修復」（Firmware Restoration）公用程式進行系統還原作業。</li>
                     </ol>
</td>
</tr>
</table>
