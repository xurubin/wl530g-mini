...
<tr>
<td class="content_desc_td" colspan="2">本項功能讓您可透過網路攝影機來監控您的作業環境。如果測到任何動作，WL530g會嘗試以電子郵件來警告您。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄位為指出您想要傳送電子郵件目的電子郵件伺服器。如果您將本欄位保持空白，WL530g將會自下方的電子郵件帳號當中去搜尋一「郵件交換主機（Mail Exchanger）。', LEFT);" onMouseOut="return nd();">電子郵件伺服器：
