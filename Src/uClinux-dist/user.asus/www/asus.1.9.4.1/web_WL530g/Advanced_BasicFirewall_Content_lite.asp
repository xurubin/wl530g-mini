...
<tr>
<td class="content_desc_td" colspan="2">「啟用防火牆」功能可為WL530g及在其之後的裝置提供基本的保護。如果您要過濾出一些特定的封包，請採用在次頁中所述的WAN vs. LAN過濾。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本項功能讓您可透過網際網路來管理WL530g。如果您現在處理「家用閘道器」的模式，請透過8080通訊埠來存取WL530g（亦即請在您的瀏覽器中輸入URL，例如http://192.168.123.1:8080）。因為此瀏覽器（80）的預設通訊埠是專為您本地網路中的Web伺服器所保留的。', LEFT);" onMouseOut="return nd();">從網際網路設定WL530g？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄為讓您指定用以透過網際網路存取Web伺服器的通訊埠。', LEFT);" onMouseOut="return nd();">從網際網路設定WL530g所使用的通訊埠：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本項功能讓您可透過網際網路來回應Ping要求（ping request）。', LEFT);" onMouseOut="return nd();">從網際網路回應PING要求？
