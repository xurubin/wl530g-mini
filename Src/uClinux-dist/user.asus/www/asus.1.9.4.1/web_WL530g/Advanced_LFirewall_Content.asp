...
<tr>
<td class="content_desc_td" colspan="2">WAN vs. WL530g過濾程式讓您可以封鎖WAN與WL530g之間的指定封包。首先，您可在兩種方向中選擇適合過濾程式的預設動作。接著，插入適用任何例外條件的規則。
         </td>
</tr>
<tr>
<td class="content_header_td">啟用WAN vs. WL530g過濾程式？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出WAN to WL530g過濾程式即可啟用的日期。', LEFT);" onMouseOut="return nd();">WAN to WL530g過濾程式啟用日期：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出WAN to WL530g過濾程式將會啟用的時間間隔。', LEFT);" onMouseOut="return nd();">WAN to WL530g啟用當日時間：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出一些在「WAN to WL530g過濾程式表」中未加指定，即將接受或丟棄的未指定WAN to WL530g封包。', LEFT);" onMouseOut="return nd();">未指定的封包（WAN to WL530g有：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出一張WAN to WL530g ICMP封包類型將會過濾的清單。例如，假設您想過濾Echo（類型8）及Echo Reply（類型0）的ICMP封包，那您必須輸入一組含有數字但以空格隔開的字串，例如0 5。', LEFT);" onMouseOut="return nd();">過濾後的ICMP(WAN to WL530g)封包類型：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出何種WL530g與WAN之間將會記錄的封包種類。', LEFT);" onMouseOut="return nd();">WL530g與WAN之間的記錄類型：
...
<td class="content_list_header_td" width="60%" id="WLocalFilterList">WAN to WL530g過濾程式表
