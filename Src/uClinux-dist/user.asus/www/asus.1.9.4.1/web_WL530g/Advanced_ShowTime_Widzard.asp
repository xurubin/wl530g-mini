...
{  
   ...
   {
      rst = confirm("您已設定好靜態IP，您要將此URL加到「我的最愛」，好讓您能從WAN網路上來使用它嗎？");
   ...
   {
      rst = confirm("您已設定好一個DDNS帳號，您要將此URL加到「我的最愛」，好讓您能從WAN網路上來使用它嗎？");
...
<p>  
   ...
   <input class=inputSubmit onClick="addbookmark()" type="button" value="「加到我的最愛」" name="action"></font></div> 
</p>
</td>
</tr>
<tr>
<td colspan="2"></td>
<td width="10" style="padding-top:2;padding-bottom:2;padding-left:2" onMouseOver="return overlib('將游標移至影像區上，點選滑鼠左鍵以擷取影像。點選滑鼠右鍵可錄製影片，再點選右鍵即可停止錄製。', CENTER, CAPTION, 'Active User的專屬小技巧');" onMouseOut="return nd();">
...
<b>
如果您是使用「ActiveX及更新」模式，卻仍然看不到任何影像，請按以下連結採另外方式顯示。. <a href="javascript:openLink('x_WImageStatic')" name="PrinterStatus_x_WImageStatic_link">here</a>
</b>
</font>
</td>
</tr>
