...
<tr>
<td class="content_desc_td" colspan="2">WL530g可支援多達253個IP位址供您的本地網路使用。本地設備的IP位址可由網路管理員手動指定或在DHCP伺服器啟用時，自動從WL530g處取得。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄位為指出您LAN網路中閘道器的IP位址。如果您空著不填，便會指定為WL530g的IP位址。', LEFT);" onMouseOut="return nd();">預設閘道器：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄為指出可提供客戶端向DHCP伺服器要求IP位址途徑的網域名稱。本欄為指出提供給客戶端向DHCP伺服器要求IP位址的網域名稱的IP位址。您可以空著不填，那麼DNS要求便會交由WL530g處理。', LEFT);" onMouseOut="return nd();">DNS伺服器1：
