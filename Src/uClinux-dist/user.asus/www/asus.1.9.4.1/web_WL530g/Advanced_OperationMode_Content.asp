...
WL530g支援三種可滿足不同需求的操作模式。請選擇能符合您現況的模式。
</td>
</tr>
<tr>
<td class="content_header_td_30"><input type="radio" name="x_Mode"> 家用閘道器</td>
<td class="content_desc_td">
在此種模式中，我們建議您使用WL530g透過ADSL或Cable Modem來連結網際網路。同時，在您的環境中許多人都可分享同一IP來使用ISP。
<p></p>
...
<td class="content_desc_td">
在「路由器」模式中，我們建議您使用WL530g來連上您公司內部的區域網路（LAN）。現在，您便可設定路由通訊協定以符合您的辦公環境需求。
<p></p>
...
<p></p>
從專業術語的角度解釋，無線網路橋接器模式是 - 取消網路位址轉換（NAT），允許將WL530g的一組網際網路通訊埠（WAN port）與四組區域網路通訊埠（LAN port）橋接在一起。
</td>
</tr>
<tr>
