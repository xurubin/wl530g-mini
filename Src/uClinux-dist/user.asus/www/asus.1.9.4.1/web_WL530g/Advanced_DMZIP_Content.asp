...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一WL530g的IP位址與您在此分離式無線本地網路中所見相同。', LEFT);" onMouseOut="return nd();">IP位址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一WL530g的「子網路遮罩」與您在此分離式無線本地網路中所見相同。', LEFT);" onMouseOut="return nd();">子網路遮罩：
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
</table>
</td>
