  ...
  <tr bgcolor="#CCCCCC"> 
    <td width="666" height="125"> 
      <table width="660" height="125" cellpadding="2" cellspacing="0" border="0">
        <tbody> 
        <tr> 
          <td bgcolor="#FF0000" height="50" width="652"><b><font size="5" face="Arial" color="#FFFFFF">設定檔上傳失敗！</font></b></td>
        </tr>
        <tr> 
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial">設定檔上傳失敗。原因可能出自設定檔錯誤或傳輸出現問題。請確認設定檔的有效性後再做嘗試。</font></td>
        </tr>
        <tr> 
