...
<td class="content_header_td_title" colspan="2">狀態及記錄 - 11a介面</td>
</tr>
<tr class="content_header_tr">
...
<table width="666" border="1" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_header_tr">
<td class="content_header_td_title" colspan="2">狀態及記錄 - 11g介面</td>
</tr>
<tr class="content_header_tr">
<td colspan="2"><textarea class="content_log_td" cols="63" rows="10" wrap="off" readonly="1">
...
<table width="666" border="1" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr>
<td class="content_header_td_less">無線上網控制：
           </td><td class="content_input_td"><input type="submit" maxlength="15" class="content_input_fd_ro" onClick="return onSubmitApply('radio_disable')" size="12" name="WLANConfig11b_WirelessCtrl_button" value="停用"><input type="submit" maxlength="15" class="content_input_fd_ro" onClick="return onSubmitApply('radio_enable')" size="12" name="WLANConfig11b_WirelessCtrl_button1" value="啟用"></td>
</tr>
</table>
</td>
</tr>
