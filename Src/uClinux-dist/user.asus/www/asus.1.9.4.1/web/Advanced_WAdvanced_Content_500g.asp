...
<tr>
<td class="content_header_td" onMouseOver="return overlib('選擇「Yes」，可以日期及時間啟用無線上網（Enable Radio）功能。', LEFT);" onMouseOut="return nd();">啟用無線上網？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出啟用無線上網功能的日期。', LEFT);" onMouseOut="return nd();">無線上網啟用日期：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出啟用無線上網功能的時間間隔。', LEFT);" onMouseOut="return nd();">無線上網啟用當日時間：
