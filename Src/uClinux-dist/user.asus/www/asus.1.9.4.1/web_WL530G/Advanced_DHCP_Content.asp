...
<tr>
<td class="content_desc_td" colspan="2">WL530G는 최대 253개의 로컬 네트워크 IP 주소를 지원합니다. 로컬 머신의 IP주소는 네트워크 관리자로 부터 수동 할당받거나 DHCP 서버가 활성화 된 경우 WL530G로 부터 자동 부여받을 수 있습니다.
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 LAN 게이트웨이의 IP주소를 표시합니다. 공란으로 두면WL530G의 IP주소가 할당 됩니다.', LEFT);" onMouseOut="return nd();">기본설정 게이트웨이:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 DHCP서버의 IP 주소를 요청하는 클라이언트들에게 제공하는 DNS의 IP주소를 나타냅니다. 공란으로 두면DNS 요청은 WL530G가 처리하게 됩니다.', LEFT);" onMouseOut="return nd();">DNS 서버 1:
