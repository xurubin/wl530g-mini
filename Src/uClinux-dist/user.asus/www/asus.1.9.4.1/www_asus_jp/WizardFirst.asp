...
<table width="420" border="0" cellpadding="0" cellspacing="0" &ace="30" height="1">
  <tr bgcolor="#FFFFFF"> 
    <td width="420" height="125"> 
      <table width="420" height="125" border="0" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>           
          ...
          <p><input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver=buttonOver(this) type="button" onClick="redirect()" value="次へ" name="action"></p>
          </td>
        </tr>            
        </tbody> 
      </table>
