...
<td class="content_header_td_title" colspan="2">ルータ - ダイナミックルート</td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('RIPパケットの送受信はどちらも、WANポートで有効または無効にされます。', LEFT);" onMouseOut="return nd();">WANのRIPを有効にしますか?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは選択されたインターフェイスを有効にして、RIPバージョン1、RIPバージョン2「、または両方を持つパケットを送受信します。両方を持つ場合、パケットは一斉通信と同報通信を実行します。', LEFT);" onMouseOut="return nd();">RIPバージョン:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('スプリットホライゾン経路メカニズムがポートで適用されるかどうかを制御します。', LEFT);" onMouseOut="return nd();">スプリットホライゾンを有効にしますか?
           </td><td class="content_input_td"><input type="radio" value="1" name="" class="content_input_fd" onClick="return change_common_radio(this, 'RouterConfig', '', '1')" <% nvram_match_x("RouterConfig","", "1", "checked"); %>>Yes</input><input type="radio" value="0" name="" class="content_input_fd" onClick="return change_common_radio(this, 'RouterConfig', '', '0')" <% nvram_match_x("RouterConfig","", "0", "checked"); %>>No</input></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('ポートに適用される認証メカニズムと対応するキーを選択します。', LEFT);" onMouseOut="return nd();">認証方式:
...
<tr>
<td class="content_header_td">認証キー:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('RIPパケットの送受信は共に、LANポートで有効または無効にされます。', LEFT);" onMouseOut="return nd();">LANのRIPを有効にしますか?
           </td><td class="content_input_td"><input type="radio" value="1" name="" class="content_input_fd" onClick="return change_common_radio(this, 'RouterConfig', '', '1')" <% nvram_match_x("RouterConfig","", "1", "checked"); %>>Yes</input><input type="radio" value="0" name="" class="content_input_fd" onClick="return change_common_radio(this, 'RouterConfig', '', '0')" <% nvram_match_x("RouterConfig","", "0", "checked"); %>>No</input></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは選択されたインターフェイスを有効にして、RIPバージョン1、RIPバージョン2「、または両方を持つパケットを送受信します。両方を持つ場合、パケットは一斉通信と同報通信を実行します。', LEFT);" onMouseOut="return nd();">RIPバージョン:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('スプリットホライゾン経路メカニズムが、ポートに適用されているかどうかを制御します。', LEFT);" onMouseOut="return nd();">スプリットホライゾンを有効にしますか?
           </td><td class="content_input_td"><input type="radio" value="1" name="" class="content_input_fd" onClick="return change_common_radio(this, 'RouterConfig', '', '1')" <% nvram_match_x("RouterConfig","", "1", "checked"); %>>Yes</input><input type="radio" value="0" name="" class="content_input_fd" onClick="return change_common_radio(this, 'RouterConfig', '', '0')" <% nvram_match_x("RouterConfig","", "0", "checked"); %>>No</input></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('ポートに適用される認証メカニズムと対応するキーを選択します。', LEFT);" onMouseOut="return nd();">認証方式:
...
<tr class="content_section_header_tr">
<td class="content_section_header_td" colspan="2">タイマー
            </td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('更新タイマーの各秒ごとに、RIPプロセスはすべての隣接RIPルータに対する完全な経路表を含む非請求応答メッセージを送信するようにうながされます。', LEFT);" onMouseOut="return nd();">更新時間:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('タイムアウトが終了すると、経路はもはや有効ではありません;ただし、経路が脱落したことを近接に通知できるように、経路は短時間、経路表に維持されます。', LEFT);" onMouseOut="return nd();">タイムアウト時間:
           </td><td class="content_input_td"><input type="text" maxlength="5" class="content_input_fd" size="5" name="" value="<% nvram_get_x("RouterConfig",""); %>" onBlur="validate_range(this, 0, 65535)" onKeyPress="return is_number(this)"></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('不要部分の整理タイマーの期限が切れると、経路は経路表から最終的に削除されます。', LEFT);" onMouseOut="return nd();">不要部分の整理時間:
           </td><td class="content_input_td"><input type="text" maxlength="5" class="content_input_fd" size="5" name="" value="<% nvram_get_x("RouterConfig",""); %>" onBlur="validate_range(this, 0, 65535)" onKeyPress="return is_number(this)"></td>
</tr>
<tr class="content_section_header_tr">
<td class="content_section_header_td" colspan="2">経路分布
            </td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">これらの規則は、RIPパスをフィルタするために使用されます。当社では、WANおよびLANポートの入出力データを表すために、4つの基本経路フィルタタイプを定義しています。各タイプに対して、経路分布フィルタ表で指定されたこれらの一致するネットワークだけを処理するか落とすかを設定できます。
         </td>
</tr>
<tr>
<td class="content_header_td">WANから受信された、タイプ0経路に対して、以下に指定されたこれらの経路だけ:
...
<tr>
<td class="content_header_td">WANに送信された、タイプ1経路に対して、以下に指定されたこれらの経路だけ:
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'RouterConfig', '')"><option class="content_input_fd" value="1" <% nvram_match_x("RouterConfig","", "1","selected"); %>>processed</option><option class="content_input_fd" value="0" <% nvram_match_x("RouterConfig","", "0","selected"); %>>dropped</option></select></td>
</tr>
<tr>
<td class="content_header_td">LANから受信された、タイプ2経路に対して、以下に指定されたこれらの経路だけ:
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'RouterConfig', '')"><option class="content_input_fd" value="1" <% nvram_match_x("RouterConfig","", "1","selected"); %>>processed</option><option class="content_input_fd" value="0" <% nvram_match_x("RouterConfig","", "0","selected"); %>>dropped</option></select></td>
</tr>
<tr>
<td class="content_header_td">LANに送信された、タイプ3経路に対して、以下に指定されたこれらの経路だけ:
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'RouterConfig', '')"><option class="content_input_fd" value="1" <% nvram_match_x("RouterConfig","", "1","selected"); %>>processed</option><option class="content_input_fd" value="0" <% nvram_match_x("RouterConfig","", "0","selected"); %>>dropped</option></select></td>
</tr>
</table>
</td>
...
<td class="content_list_header_td" width="60%" id="RouteFilter">経路分布フィルタ
         <input type="hidden" name="RipDRouteCount_0" value="<% nvram_get_x("RouterConfig", "RipDRouteCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RouteFilter', 16, ' Add ');" name="RouteFilter" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RouteFilter', 16, ' Del ');" name="RouteFilter" value="削除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'RouterHelp');" name="RouteFilter" value="ヘルプ" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="">経路タイプ	                
           	        </td><td class="content_list_field_header_td" colspan="">ネットワーク/ホストIP	                
...
<table width="666" border="1" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_section_header_tr">
<td class="content_section_header_td" colspan="2">経路メトリック規則
            </td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">RIPメトリックはネットワークに対する距離の値です。通常、RIPはネットワーク情報を受信したときにメトリックを増加します。再配分された経路のデフォルトメトリックオフセットは、1に設定されています。これらの規則は、経路メトリックオフセット表で指定されたまたは除外された一致ネットワークに対してのみ、メトリックオフセットを変更するために使用できます。しかし、その他のネットワークのメトリックオフセットはまだ1に設定されます。
         </td>
</tr>
<tr>
<td class="content_header_td">経路メトリックオフセット:
...
<tr>
<td class="content_header_td">入力経路に対して、メトリックオフセットを追加します
...
<tr>
<td class="content_header_td">出力経路に対して、メトリックオフセットを設定します
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'RouterConfig', '')"><option class="content_input_fd" value="0" <% nvram_match_x("RouterConfig","", "0","selected"); %>>none</option><option class="content_input_fd" value="1" <% nvram_match_x("RouterConfig","", "1","selected"); %>>routes specified below</option><option class="content_input_fd" value="2" <% nvram_match_x("RouterConfig","", "2","selected"); %>>routes not specified below</option></select></td>
</tr>
</table>
</td>
...
<table width="666" border="2" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_list_header_tr">
<td class="content_list_header_td" width="60%" id="RipOffset">経路メトリックオフセット
         <input type="hidden" name="RipOffsetCount_0" value="<% nvram_get_x("RouterConfig", "RipOffsetCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RipOffset', 16, ' Add ');" name="RipOffset" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'RipOffset', 16, ' Del ');" name="RipOffset" value="削除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'RouterHelp');" name="RipOffset" value="ヘルプ" size="12">
</div>
</td><td width="5%"></td>
</tr>
<table class="content_list_table" width="640" border="0" cellspacing="0" cellpadding="0">
