...
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'VSList', 24, ' Add ');" name="VSList" value="추가" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'VSList', 24, ' Del ');" name="VSList" value="삭제" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="">포트영역	                
           	        </td><td class="content_list_field_header_td" colspan="">로컬IP	                
           	        </td><td class="content_list_field_header_td" colspan="">로컬포트 범위	                
           	        </td><td class="content_list_field_header_td" colspan="">프로토콜	                
           	        </td><td class="content_list_field_header_td" colspan="">프로토콜 번호	                
