...
<td class="content_desc_td" colspan="2" width="614">
                  <p style="margin-top: 7">본 기능은 ZVMODELVZ의 현재 설정을 파일로 저장하거나 파일로 부터 설정을 가져 올 수 있도록 합니다.
</td>
</tr>
...
<p style="margin-top: 7"> 
                 커서 이동 <a href="/ZVMODELVZ.CFG">HERE</a>. 마우스 오른 쪽 버튼을 클릭한 후 <b>"…….로 저장"</b>을 선택하여 ZVMODELVZ의 현재 설정을 파일로 저장합니다. (참고: 현재 설정을 파일로 저장하는 동안 플래시로도 저장됩니다.
...
<td class="content_desc_td" colspan="2" width="614">                           		                                     		
              <p style="margin-top: 7">
              다운로드하는 파일의 경로명과 이름을 아래의 <b>"새 설정 파일"</b>에서 정합니다. 그리고 난 후 <b>"업로드"</b>를 클릭하여 파일을 ZVMODELVZ에 쓰기합니다. 잠시 후 본 과정이 끝나고 시스템이 재부팅됩니다.            
</td>
</tr>
<tr>
