...
<tr>
<td class="content_header_td" onMouseOver="return overlib('请选择一个区段（Session）作为您默认的连接。「区段0」是指在WAN和LAN设置中所设置的PPPoE区段。', LEFT);" onMouseOut="return nd();">预设的PPPoE区段：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可让您将状态设置为在一段特定的时间后即终止您的ISP连接。数值0为允许无限期的闲置时间。如果勾选「仅针对Tx」，则接收自互联网的资料将会跳过以便计算闲置时间。', LEFT);" onMouseOut="return nd();">闲置断线时间（可选）：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('亦即是指PPPoE封包的「最大传输单元」（MTU）。', LEFT);" onMouseOut="return nd();">最大传输单元（MTU）：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('亦即是指PPPoE封包的「最大接收单元」（MRU）。', LEFT);" onMouseOut="return nd();">最大接收单元（MRU）：
           </td><td class="content_input_td"><input type="text" maxlength="5" size="5" name="" class="content_input_fd" value="<% nvram_get_x("PPPConnection", ""); %>" onBlur="validate_range(this, 576, 1492)" onKeyPress="return is_number(this)"></td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项或许某些ISP能够指定。请向您的ISP确认并于需要时将它们填入。', LEFT);" onMouseOut="return nd();">访问集中器名称（选项）：
           </td><td class="content_input_td"><input type="text" maxlength="32" class="content_input_fd" size="32" name="" value="<% nvram_get_x("PPPConnection",""); %>" onKeyPress="return is_string(this)" onBlur="validate_string(this)"></td>
</tr>
<tr class="content_section_header_tr">
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可让您将状态设置为在一段特定的时间后即终止您的ISP连接。数值0为允许无限期的闲置时间。如果勾选「仅针对Tx」，则接收自互联网的资料将会跳过以便计算闲置时间。', LEFT);" onMouseOut="return nd();">秒数「闲置断线时间」（选项）：
           </td><td class="content_input_td"><input type="text" maxlength="10" class="content_input_fd" size="10" name="" value="<% nvram_get_x("PPPConnection",""); %>" onBlur="validate_range(this, 0, 4294967295)" onKeyPress="return is_number(this)"><input type="checkbox" style="margin-left:30" name="_check" value="" onClick="return change_common_radio(this, 'PPPConnection', '', '1')">Tx Only</input></td>
</tr>
<input type="hidden" name="" value="<% nvram_get_x("PPPConnection",""); %>">
<tr>
