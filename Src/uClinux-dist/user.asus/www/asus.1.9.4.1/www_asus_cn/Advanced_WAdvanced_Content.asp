...
<tr>
<td class="content_header_td" onMouseOver="return overlib('启用AfterBurner功能时，使用具备AfterBurner功能的无线网络卡与路由器相连将可大幅度增强无线传输的性能。AfterBurner模式操作需要：将「认证方式」设置为「Open System or Shared Key」，而AP模式则设置为「AP Only」并将「允许匿名」设置为「No」。', LEFT);" onMouseOut="return nd();">启用AfterBurner功能？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('选择「Yes」，可启用突发帧功能来增强性能。', LEFT);" onMouseOut="return nd();">启用突发帧功能？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('选择「基站」时，ZVMODELVZ将会接上在「无线 – 界面」页面中所指定的AP。选择「以太网络桥接器」时，ZVMODELVZ将会接上在「无线 – 界面」页面中所指定的AP，并允许与ZVMODELVZ的LAN端口连接的装置一并连接至此AP上。「基站」及「以太网络桥接器」模式仅在「认证方式」设为「系统开放」、「共享密钥」或「 WPA-PSK」时，才能发挥作用。', LEFT);" onMouseOut="return nd();">扩展模式：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('选择「Yes」，可以在自定义的日期及时间启用无线上网（Enable Radio）功能。', LEFT);" onMouseOut="return nd();">启用无线上网？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义启用无线上网功能的日期。', LEFT);" onMouseOut="return nd();">无线上网启用日期：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义启用无线上网功能的时间间隔。', LEFT);" onMouseOut="return nd();">无线上网启用的时间：
...
<tr>
<td class="content_header_td">激活 WMM?
...
<tr>
<td class="content_header_td">激活 WMM No-Acknowledgement？
