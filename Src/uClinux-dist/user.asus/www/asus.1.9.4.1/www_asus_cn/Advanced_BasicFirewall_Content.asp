...
<tr>
<td class="content_desc_td" colspan="2">「启用防火墙」功能可为ZVMODELVZ及在其之后的装置提供基本的保护。如果您要过滤出一些特定的封包，请采用将在下页中提到的WAN vs. LAN过滤。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您通过互联网来管理ZVMODELVZ。如果您的设备现在正处于「家用网关」的模式，请通过8080端口来访问ZVMODELVZ（亦即请在您的浏览器中输入URL，例如http://192.168.123.1:8080）。因为此浏览器（80）的预设端口是专为您本地网络中的Web服务器所保留的。', LEFT);" onMouseOut="return nd();">启用WAN接口的Web访问功能？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目为让您指定端口号用来通过互联网访问Web服务器。', LEFT);" onMouseOut="return nd();"> Web访问端口号（从WAN接口访问）：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您通过互联网来回应LPR请求。', LEFT);" onMouseOut="return nd();">从WAN回应LPR请求？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您通过互联网来回应Ping请求数据包（ping request）。', LEFT);" onMouseOut="return nd();">回应来自WAN的Ping请求数据包？
