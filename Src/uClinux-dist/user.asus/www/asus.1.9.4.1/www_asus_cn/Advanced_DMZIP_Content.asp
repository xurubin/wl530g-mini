...
<tr>
<td class="content_desc_td" colspan="2">「无线防火墙」（Wireless Firewall）可让您以建立起一个单独的无线本地网络。而所有来自此网络内的客户端（clients）的封包将受到您设置的过滤器规则所控制。
         <div align="center">
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义哪个设备将会接受「无线防火墙」的控制。', LEFT);" onMouseOut="return nd();">应用设备：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此ZVMODELVZ的IP地址与您在此无线本地网络中所见的相同。', LEFT);" onMouseOut="return nd();">IP地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此ZVMODELVZ的「子网掩码」与您在此无线本地网络中所见的相同。', LEFT);" onMouseOut="return nd();">子网掩码：
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
</table>
</td>
