...
<p></p>
从专业术语的角度解释，AP接入点模式：取消网络地址转换（NAT），允许将ZVMODELVZ的一组局域网端口及无线端口桥接在一起。
</td>
</tr>
<tr>
...
<p></p>
从专业术语的角度解释，网关模式是 - 启用网络地址转换（NAT），允许使用PPPoE、DHCP 用户端，或静态IP来进行广域网（WAN）连接操作。另外，也支持一些对家庭用户相当有用的功能，像是UPNP及动态DNS（DDNS）。
</td>
</tr>
<tr>
