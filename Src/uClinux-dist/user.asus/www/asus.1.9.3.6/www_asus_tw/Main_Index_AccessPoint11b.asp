...
<table height="22" width="666">
  ...
  <tr bgcolor="#FFFF00"> 
    <td class="content_desc_td_home"> 
      ...
      <ul>
        <li> 
          <p style="word-spacing: 0; margin-top: 0; margin-bottom: 0"> <a href="javascript:top.openBranch('快速安裝')"><b>快速安裝</b></a>只須回答幾個問題，便可讓用戶完成基本設定。</li>
        <li> <b><a href="javascript:top.openBranch('無線')">802.11b和WPA</a> &nbsp;</b>可支援最高11Mbps傳輸率及及跨平台的安全強化性。</li>          
        <li> <b><a href="javascript:top.openBranch('狀態及記錄')">狀態及記錄</a></b>詳細記錄系統的狀態。</li><p> 
