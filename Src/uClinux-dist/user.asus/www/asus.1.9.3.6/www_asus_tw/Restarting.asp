  ...
  <tr bgcolor="#CCCCCC"> 
    <td width="666" height="125"> 
      <table width="660" height="125" cellpadding="2" cellspacing="0" border="0">
        <tbody>
        <tr> 
          <td bgcolor="#FF0000" height="50" width="652"><b><font size="5" face="Arial" color="#FFFFFF">系統重新啟動中！</font></b></td>
        </tr>
        <tr>
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2">系統正在重新啟動！請稍候直到再度顯示ZVMODELVZ設定的首頁畫面為止。</td>
         </tr>
        <tr> 
        ...
        <tr>
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial"> 
            <font color="#FF0000"><b>註：需時約20秒。</b></font></font></td>
        </tr>
        </tbody>
      </table>
    </td>
