...
<td class="content_header_td_title" colspan="2">狀態及記錄 - 系統記錄</td>
</tr>
<tr class="content_header_tr">
...
<tr bgcolor="#FFFFFF">  
   ...
   <input type="hidden" name="next_host" value="">
   <div align="center"><font face="Arial"> <input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="document.form2.next_host.value = location.host; onSubmitCtrl(this, ' Save ')" type="submit" value="儲存" name="action"></font></div> 
   </form>
   </td>
   <td height="25" width="33%">
   ...
   <input type="hidden" name="next_host" value="">
   <div align="center"><font face="Arial"> <input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="document.form3.next_host.value = location.host; onSubmitCtrl(this, ' Refresh ')" type="submit" value="更新" name="action"></font></div> 
   </form>
   </td>
</tr>
</table>
