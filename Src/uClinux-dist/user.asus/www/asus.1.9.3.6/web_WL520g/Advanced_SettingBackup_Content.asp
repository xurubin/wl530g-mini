...
<td class="content_desc_td" colspan="2" width="614">
                  <p style="margin-top: 7">本项功能可让您将目前的WL520g的设置保存成文件，或从文件中载入设置。
</td>
</tr>

<tr class="content_section_header_tr">
<td id="Mode" class="content_section_header_td" colspan="2" width="614">另存新文件</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2" width="614">
<p style="margin-top: 7"> 
                 请将您的光标移到文件上。 <a href="/WL520g.CFG">HERE</a>. 接着点选鼠标右键并选择<b>「另存为....」</b>将目前WL520g的设置保存成文件。（注：在您将目前的设置保存成文件时，亦同样会存入闪存内。）
...
<td class="content_desc_td" colspan="2" width="614">                           		                                     		
              <p style="margin-top: 7">
              请将下载文件的路径及名称指定到下方的<b>「新设置档」</b>中。接着，点选<b>「上传」</b> 将文件写入ZVMODELV Z。整个过程需要一些时间来完成，然后系统将会重新开机。            
</td>
</tr>
<tr>
