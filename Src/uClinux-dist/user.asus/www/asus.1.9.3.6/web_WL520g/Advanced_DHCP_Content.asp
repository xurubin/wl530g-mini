...
<tr>
<td class="content_desc_td" colspan="2">WL520g可支持多达253个IP地址供您的本地网络使用。本地设备的IP地址可由网络管理员手动指定或在DHCP服务器启用时，自动从WL520g取得。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了您LAN网络中网关的IP地址。如果您空着不填，便会指定为WL520g的IP地址。', LEFT);" onMouseOut="return nd();">预设网关：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了提供给用户端向DHCP服务器要求IP地址的域名的IP地址。您可以空着不填，那么DNS要求便会交由WL520g处理。', LEFT);" onMouseOut="return nd();">DNS服务器1：
