...
<tr>
<td class="content_desc_td" colspan="2" height="50">
WL520g支持数种通过其WAN端口连接互联网的连接方式。请选择您需要的连接类型。另外，在连上互联网之前，请确定您已将WL520g的WAN端口接上您的DSL（数字用户线路）或Cable Modem（电缆调制解调器）。</td>
</tr>
<tr> 
          <td class="content_header_td_less" onMouseOut="return nd();" colspan="2">          
          <p></p>
          <p><input type="radio" checked name="x_WANType" value="1" class="content_input_fd" onClick="changeWANType()">电缆调制解调器（Cable Modem）或其他可自动取得IP的连接类型。</p>          
          <p><input type="radio" checked name="x_WANType" value="2" class="content_input_fd" onClick="changeWANType()">需要用户名称及密码的ADSL连接，PPPoE。您的ISP可以参照这种连接。</p>          
          <p><input type="radio" checked name="x_WANType" value="3" class="content_input_fd" onClick="changeWANType()">需要用户名称、密码及IP地址的ADSL连接，PPTP。您的ISP可以参照这种连接。</p>          
          <p><input type="radio" checked name="x_WANType" value="4" class="content_input_fd" onClick="changeWANType()">ADSL或其他使用静态IP地址的连接类型。</p>
          <p><input type="radio" checked name="x_WANType" value="5" class="content_input_fd" onClick="changeWANType()">Telstra BigPond 宽频数据服务</p>
          <p></p>
          <p></p>
          </td>
</tr>
...
<tr>
<td class="content_desc_td" colspan="2" height="50">如果您采用的是一含有动态IP的ADSL帐号，那您必须向您的互联网服务供应商取得用户帐号及密码。请将此项资料仔细填入以下的栏目里。或者，如果您采用的是含有静态IP的ADSL帐号，可省略用户名称及密码信息。</td>
</tr>
<tr>
...
<tr>
<td class="content_desc_td" colspan="2" height="50">您的ISP可能会需要以下资料以确认您的帐号。如果没有，就请按「下一步」省略。</td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('本栏目可让您提供WL520g所使用的主机名称。通常是您ISP要求的名称。', LEFT);" onMouseOut="return nd();">主机名称（Host Name）：</td><td class="content_input_td"><input type="text" maxlength="32" size="32" name="wan_hostname" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hostname"); %>"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('本栏目可让您提供WL520g连接互联网所使用的特有MAC（媒体访问控制）地址。通常是您ISP要求的地址。', LEFT);" onMouseOut="return nd();"> MAC（媒体访问控制） 地址：</td><td class="content_input_td"><input type="text" maxlength="12" size="12" name="wan_hwaddr_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hwaddr_x"); %>" onBlur="return validate_hwaddr(this)" onKeyPress="return is_hwaddr()"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('请输入认证服务器的名称或地址。', LEFT);" onMouseOut="return nd();">认证服务器:</td><td class="content_input_td"><input type="text" maxlength="12" size="12" name="wan_heartbeat_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_heartbeat_x"); %>"></td>
</tr>
<tr>
...
<tr>
<td class="content_desc_td" colspan="2" height="50">请填写WL520g通过WAN端口连接互联网所使用的TCP/IP设置。</td>
</tr>
<tr>
<td class="content_header_td_less">自动取得IP？</td><td class="content_input_td"><input type="radio" value="1" name="x_DHCPClient" class="content_input_fd" onClick="changeDHCPClient()">Yes</input><input type="radio" value="0" name="x_DHCPClient" class="content_input_fd" onClick="changeDHCPClient()">No</input></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('WAN界面的IP地址。如果您空着不填，WL520g会自动向DHCP服务器取得IP地址。', LEFT);" onMouseOut="return nd();">IP Address:</td><td class="content_input_td"><input type="text" maxlength="15" size="15" name="wan_ipaddr" class="content_input_fd" value="<% nvram_get_x("IPConnection","wan_ipaddr"); %>" onBlur="return validate_ipaddr(this, 'wan_ipaddr')" onKeyPress="return is_ipaddr(this)"></td>
</tr>
<tr>
...
<tr>
<td class="content_header_td_less">预设网关：</td><td class="content_input_td"><input type="text" maxlength="15" size="15" name="wan_gateway" class="content_input_fd" value="<% nvram_get_x("IPConnection","wan_gateway"); %>" onBlur="return validate_ipaddr(this)" onKeyPress="return is_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td_less">自动取得DNS服务器？</td><td class="content_input_td"><input type="radio" value="1" name="wan_dnsenable_x" class="content_input_fd" onClick="changeDNSServer()" <% nvram_match_x("IPConnection","wan_dnsenable_x", "1", "checked"); %>>Yes</input><input type="radio" value="0" name="wan_dnsenable_x" class="content_input_fd" onClick="changeDNSServer()" <% nvram_match_x("IPConnection","wan_dnsenable_x", "0", "checked"); %>>No</input></td>
</tr>
<tr>
...
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('为您的无线局域网（WLAN）指定一组可为32个字符的识别字串。', LEFT);" onMouseOut="return nd();">SSID，服务设置识别码</td><td class="content_input_td"><input type="text" maxlength="32" size="32" name="wl_ssid" class="content_input_fd" value="<% nvram_get_x("WLANConfig11b","wl_ssid"); %>"  onBlur="validate_string(this)"></td>
</tr>
<tr>
