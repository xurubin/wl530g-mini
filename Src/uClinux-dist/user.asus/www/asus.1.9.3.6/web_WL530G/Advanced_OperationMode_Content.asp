...
WL530G는 그룹 구성원들의 요구사항을 충족시키기 위하여 3가지의 작동모드를 지원합니다. 상황에 맞는 모드를 선택하십시오.
</td>
</tr>
<tr>
<td class="content_header_td_30"><input type="radio" name="x_Mode"> 홈 게이트웨이</td>
<td class="content_desc_td">
본 모드에서는 ADSL 또는 케이블 모뎀을 통한 인터넷 연결을 위하여 사용자가 WL530G를 사용하고 있고 ISP와 동일한 IP 환경을 공유한 사람들이 많이 있는 것으로 가정합니다.
<p></p>
...
<td class="content_desc_td">
라우터 모드에서는 회사와의 LAN 연결을 위하여 WL530G를 사용하고 있는 것으로 가정합니다. 따라서 사무실에서 사용자의 요구사항을 충족시킬 수 있는 라우팅 프로토콜을 설정할 수 있습니다.
<p></p>
...
<p></p>
전문적인 용어로 설명하면 액세스 포인트 모드에서는 NAT가 비활성화 되어 있고 WL530G의 1개의 WAN 포트와 4개의 LAN 포트가 서로 연결됩니다.
</td>
</tr>
<tr>
