...
<tr>
<td class="content_header_td" onMouseOver="return overlib('예를 선택하면 WL530G가 원격 브릿지 목록에 있는 다른 AP로 연결됩니다.', LEFT);" onMouseOut="return nd();">원격 브릿지 목록의 AP로 연결합니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('예를 선택하면 무선 브릿지 제한을 비활성화하게 됩니다. 어떠한 무선 브릿지도 접근됩니다. 아니오를 선택하면 무선 브릿지 제한이 활성화 됩니다. 원격 브릿지 목록에 있는 브릿지만이 접근할 수 있습니다.', LEFT);" onMouseOut="return nd();">익명을 허락합니까?
