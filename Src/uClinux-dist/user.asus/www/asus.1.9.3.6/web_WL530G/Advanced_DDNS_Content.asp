...
<tr>
<td class="content_header_td" onMouseOver="return overlib('만일 UpnP를 활성화하고 있는 경우에는 Windows XP등의 운영 시스템이 자동으로 WL530G를 발견합니다. 그리고 운영시스템이 게임, 비디오 컨퍼런스등 여러 종류의 인터넷 어플리케이션에 대하여 자동으로 WL530G의 컨피규레이션을 할 수 있도록 합니다.', LEFT);" onMouseOut="return nd();">UpnP를 활성화하겠습니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 기능은 WL530G의 로그 메시지를 기록하기 위하여 원격서버를 할당할 수 있도록 합니다. 공란으로 두면 시스템이 WL530G에만 최대 1024개의 메시지를 기록하게 됩니다.', LEFT);" onMouseOut="return nd();">원격 로그 서버:
...
<tr>
<td class="content_desc_td" colspan="2">유동DNS (DDNS)는 고정 IP주소가 아니더라도 서버가 특정한 이름을 갖고 인터넷으로 연결될 수 있도록 합니다. 현재 몇몇 DDNS 클라이언트는 WL530G에 내재되어 있습니다. 아래의 무료 트라이얼을 클릭하여 무료 트라이얼 계정을 오픈할 수 있습니다.
         </td>
</tr>
<tr>
