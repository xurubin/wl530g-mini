...
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('BigPond 서비스 인증서버의 서버 이름 혹은 서버 IP를 입력하십시오.', LEFT);" onMouseOut="return nd();">Heart-Beat 서버</td><td class="content_input_td"><input type="text" maxlength="12" size="32" name="wan_heartbeat_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_heartbeat_x"); %>"></td>
</tr>
<tr>
