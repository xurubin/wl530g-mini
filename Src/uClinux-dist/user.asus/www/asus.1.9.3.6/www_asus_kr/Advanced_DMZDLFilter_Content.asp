...
<td class="content_header_td_title" colspan="2">무선 방화벽 - WLAN & LAN 필터</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">WLAN >LAN필터는 무선 방화벽이 활성화된 경우WLAN과LAN간의 패킷을 블로킹할 수 있도록 합니다. 우선 양방향 필터의 초기설정 액션을 선택할 수 있습니다. 그리고 난 후 예외에 해당하는 규칙을 삽입합니다.
         </td>
</tr>
<tr>
<td class="content_header_td">WLAN >LAN필터를 활성화하겠습니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 WLAN >LAN필터 테이블에서 정하여지지 않은 WLAN >LAN패킷의 드롭여부를 정의합니다.', LEFT);" onMouseOut="return nd();">정하여 지지 않은 패킷(WLAN >LAN):
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 필터링될 WLAN >LAN ICMP패킷의 목록을 정의합니다. 예를 들면 에코(유형 8)와 에코 응답(유형 0)  ICMP 패킷을 필터링하려면 0 5와 같이 띄어쓰기한 숫자의 문자열을 입력해야 합니다.', LEFT);" onMouseOut="return nd();">필터링된 ICMP(WLAN >LAN) 패킷유형:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 LAN >WLAN필터 테이블에서 정하여지지 않은 LAN >WLAN패킷의 드롭여부를 정의합니다.', LEFT);" onMouseOut="return nd();">정하여 지지 않은 패킷(LAN >WLAN):
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'FirewallConfig', '')"><option class="content_input_fd" value="DROP" <% nvram_match_x("FirewallConfig","", "DROP","selected"); %>>DROP</option><option class="content_input_fd" value="ACCEPT" <% nvram_match_x("FirewallConfig","", "ACCEPT","selected"); %>>ACCEPT</option></select></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 필터링될 LAN >WLAN ICMP패킷의 목록을 정의합니다. 예를 들면 에코(유형 8)와 에코 응답(유형 0)  ICMP 패킷을 필터링하려면 0 5와 같이 띄어쓰기한 숫자의 문자열을 입력해야 합니다.', LEFT);" onMouseOut="return nd();">필터링된 ICMP(LAN >WLAN) 패킷유형:
           </td><td class="content_input_td"><input type="text" maxlength="32" class="content_input_fd" size="32" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_portlist(this, '')" onKeyPress="return is_portlist(this)"></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 WLAN과 WAN간의 로그 될 패킷 유형을 나타냅니다.', LEFT);" onMouseOut="return nd();">WLAN과LAN간의 로그 유형:
...
<td class="content_list_header_td" width="60%" id="DLFilterList">WLAN > LAN 필터 테이블
         <input type="hidden" name="DmzLanRuleCount_0" value="<% nvram_get_x("FirewallConfig", "DmzLanRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DLFilterList', 32, ' Add ');" name="DLFilterList" value="추가" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DLFilterList', 32, ' Del ');" name="DLFilterList" value="삭제" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="DLFilterList" value="도움말" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<table width="666" border="2" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_list_header_tr">
<td class="content_list_header_td" width="60%" id="LDFilterList">LAN > WLAN 필터 테이블
         <input type="hidden" name="LanDmzRuleCount_0" value="<% nvram_get_x("FirewallConfig", "LanDmzRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LDFilterList', 32, ' Add ');" name="LDFilterList" value="추가" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LDFilterList', 32, ' Del ');" name="LDFilterList" value="삭제" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="LDFilterList" value="도움말" size="12">
</div>
</td><td width="5%"></td>
</tr>
<table class="content_list_table" width="640" border="0" cellspacing="0" cellpadding="0">
