...
<td class="content_header_td_title" colspan="2">무선 방화벽 - 기본 컨피규레이션</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">무선 방화벽은 별도의 무선 로컬 네트워크를 생성할 수 있도록 합니다. 네트워크 환경하의 클라이언트의 모든 패킷이 설정한 필터규칙에 의하여 제어됩니다.
         <div align="center">
<img name="WirelessFirewall_img" src="graph/wf_none.gif"></div>
</td>
</tr>
<tr>
<td class="content_header_td">무선방화벽을 활성화하겠습니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드는 무선방화벽의 제어를 받는 디바이스를 나타냅니다.', LEFT);" onMouseOut="return nd();">적용 디바이스:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('별도의 무선 로컬 네트워크에서 보이는 ZVMODELVZ의 IP주소입니다.', LEFT);" onMouseOut="return nd();">IP주소:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('별도의 무선 로컬 네트워크에서 보이는 ZVMODELVZ의 서브넷 마스크입니다.', LEFT);" onMouseOut="return nd();">서브넷 마스크:
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
</table>
</td>
