  ...
  <tr bgcolor="#CCCCCC"> 
    <td width="666" height="125"> 
      <table width="660" height="125" cellpadding="2" cellspacing="0" border="0">
        <tbody> 
        <tr> 
          <td bgcolor="#FF0000" height="50" width="652"><b><font size="5" face="Arial" color="#FFFFFF">ファームウェアをアップグレードできませんでした。</font></b></td>
        </tr>
        <tr> 
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial">ファームウェアをアップグレードできませんでした。これは、間違った画像またはエラー伝送が原因であると考えられます。ファームウェアのバージョンをチェックして、再実行してください。</font></td>
        </tr>
        <tr> 
