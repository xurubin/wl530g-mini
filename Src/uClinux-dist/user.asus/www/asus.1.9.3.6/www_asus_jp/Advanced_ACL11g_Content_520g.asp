...
<input type="hidden" name="current_page" value="Advanced_ACL_Content.asp"><input type="hidden" name="next_page" value="Advanced_WAdvanced_Content.asp"><input type="hidden" name="next_host" value=""><input type="hidden" name="sid_list" value="DeviceSecurity11a;"><input type="hidden" name="group_id" value=""><input type="hidden" name="modified" value="0"><input type="hidden" name="action_mode" value=""><input type="hidden" name="first_time" value=""><input type="hidden" name="action_script" value="">
<tr>
<td>
<table width="666" border="1" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_header_tr">
<td class="content_header_td_title" colspan="2">ワイヤレス - アクセスコントロール</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">アクセスコントロールにより、あるワイヤレス端末からのアクセスをブロックしたり、あるワイヤレス端末からのアクセスのみをバイパスできます。「受け入れ」モードでは、ZVMODELVZはコントロールリストのMACアドレスを持つ端末からワイヤレスアクセスのみを受け入れます。「拒絶」モードでは、ZVMODELVZはコントロールリストのMACアドレスを持つ端末からワイヤレスアクセスを拒絶します。
         </td>
</tr>
<tr>
<td class="content_header_td">MACアクセスモード:
...
<td class="content_list_header_td" width="60%" id="ACLList">アクセスコントロールリスト
         <input type="hidden" name="wl_macnum_x_0" value="<% nvram_get_x("DeviceSecurity11a", "wl_macnum_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'ACLList', 64, ' Add ');" name="ACLList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'ACLList', 64, ' Del ');" name="ACLList" value="削除" size="12">
</div>
</td><td width="5%"></td>
</tr>
