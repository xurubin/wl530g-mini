...
<td class="content_header_td_title" colspan="2">インターネットファイアウォール -  URLフィルタ</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">URLフィルタは、ローカルネットワークから特定のURLへのアクセスをブロックします。
         </td>
</tr>
<tr>
<td class="content_header_td">URLフィルタを有効にしますか?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは、URLフィルタが有効になる日付を定義します。', LEFT);" onMouseOut="return nd();">URLフィルタが有効になる日付:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは、URLフィルタが有効になる時間間隔を定義します。', LEFT);" onMouseOut="return nd();">URLフィルタが有効になる日時:
...
<td class="content_list_header_td" width="60%" id="UrlList"> URLキーワードしますか
         <input type="hidden" name="url_num_x_0" value="<% nvram_get_x("FirewallConfig", "url_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'UrlList', 128, ' Add ');" name="UrlList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'UrlList', 128, ' Del ');" name="UrlList" value="削除" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="">URLキーワード	                
           	        </td><td></td>
</tr>
<tr>
