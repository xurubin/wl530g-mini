...
<td class="content_header_td_title" colspan="2">ワイヤレスファイアウォール - WLANとWANフィルタ</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">ワイヤレスファイアウォールが有効になっていると、WLAN vs. WANフィルタによりWLANとWAN間の指定されたパケットをブロックできます。はじめに、両方の方向のフィルタに対してデフォルトの動作を選択できます。次に、すべての例外に対する規則を挿入してください。
         </td>
</tr>
<tr>
<td class="content_header_td">WLAN vs. WANフィルタを有効にしますか?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは、WLAN対WANフィルタ表で指定されていないWLAN対WANパケットが受け入れられるか脱落するかを定義します。', LEFT);" onMouseOut="return nd();">指定されていないパケット(WLAN対WAN):
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは、フィルタされるWLAN対WAN ICMPパケットタイプのリストを定義します。例えば、Echo(タイプ8)とEcho Reply(タイプ0) ICMPパケットをフィルタしたい場合、0 5などの、空白で区切られる数字を持つ文字列を入力する必要があります。', LEFT);" onMouseOut="return nd();">フィルタされたICMP(WLAN対WAN)パケットタイプ:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは、WAN対WLANフィルタ表で指定されていないWAN対WLANパケットが受け入れられるか脱落するかを定義します。', LEFT);" onMouseOut="return nd();">指定されていないパケット(WAN to WLAN):
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'FirewallConfig', '')"><option class="content_input_fd" value="DROP" <% nvram_match_x("FirewallConfig","", "DROP","selected"); %>>DROP</option><option class="content_input_fd" value="ACCEPT" <% nvram_match_x("FirewallConfig","", "ACCEPT","selected"); %>>ACCEPT</option></select></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは、フィルタされるWAN対WLAN ICMPパケットタイプのリストを定義します。例えば、Echo(タイプ8)とEcho Reply(タイプ0) ICMPパケットをフィルタしたい場合、0 5などの、空白で区切られる数字を持つ文字列を入力する必要があります。', LEFT);" onMouseOut="return nd();">フィルタされたICMP(WAN対WLAN)パケットタイプ:
           </td><td class="content_input_td"><input type="text" maxlength="32" class="content_input_fd" size="32" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_portlist(this, '')" onKeyPress="return is_portlist(this)"></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('このフィールドは、WLANとWAN間でログされるパケットの種類を示します。', LEFT);" onMouseOut="return nd();">WLANとWAN間のログタイプ:
...
<td class="content_list_header_td" width="60%" id="DWFilterList"> WLANとWANフィルタ表
         <input type="hidden" name="DmzWanRuleCount_0" value="<% nvram_get_x("FirewallConfig", "DmzWanRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DWFilterList', 32, ' Add ');" name="DWFilterList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DWFilterList', 32, ' Del ');" name="DWFilterList" value="削除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="DWFilterList" value="ヘルプ" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<table width="666" border="2" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_list_header_tr">
<td class="content_list_header_td" width="60%" id="WDFilterList"> WANとWLANフィルタ表
         <input type="hidden" name="WanDmzRuleCount_0" value="<% nvram_get_x("FirewallConfig", "WanDmzRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'WDFilterList', 32, ' Add ');" name="WDFilterList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'WDFilterList', 32, ' Del ');" name="WDFilterList" value="削除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="WDFilterList" value="ヘルプ" size="12">
</div>
</td><td width="5%"></td>
</tr>
<table class="content_list_table" width="640" border="0" cellspacing="0" cellpadding="0">
