...
<tr>
<td colspan="2"></td>
<td width="10" style="padding-top:2;padding-bottom:2;padding-left:2" onMouseOver="return overlib('将光标移至图像区上，点选鼠标左键以抓取图像。点选鼠标右键可录制影片，再点选右键即可停止录制。', CENTER, CAPTION, 'Active User的专属小技巧');" onMouseOut="return nd();">
...
<b>
如果您是使用「ActiveX及更新」模式，却仍然看不到任何图像，请按以下连接采另外方式显示。. <a href="javascript:openLink('x_WImageStatic')" name="PrinterStatus_x_WImageStatic_link">here</a>
</b>
</font>
</td>
</tr>
