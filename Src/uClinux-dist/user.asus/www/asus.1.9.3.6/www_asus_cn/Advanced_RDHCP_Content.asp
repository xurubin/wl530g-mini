...
<tr>
<td class="content_desc_td" colspan="2">ZVMODELVZ可支持多达253个IP地址供您的本地网络使用。本地设备的IP地址可由网络管理员手动指定或在DHCP服务器启用时，自动从ZVMODELVZ取得。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指定了由您本地网络中的DHCP服务器所指定在地址池中的第一个地址。', LEFT);" onMouseOut="return nd();">IP地址池首地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指定了由您本地网络中的DHCP服务器所指定在地址池中的最后一个地址。', LEFT);" onMouseOut="return nd();">IP地址池末地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指定了允许网络用户使用他们目前动态IP地址的全部连接时间。', LEFT);" onMouseOut="return nd();">租约时间：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了LAN网络中网关的IP地址。如不填写，默认指定为ZVMODELVZ的IP地址。', LEFT);" onMouseOut="return nd();">默认网关：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('为DHCP客户端指明DNS服务器的IP地址，如不填写，那么DNS服务请求便会交由ZVMODELVZ处理。', LEFT);" onMouseOut="return nd();">DNS服务器1：
