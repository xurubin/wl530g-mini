...
<td class="content_header_td_title" colspan="2">IP设置 - 基本设置</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">带宽管理可以让您控制不同应用程序对内或对外所占用的带宽。
         </td>
</tr>
<tr>
<td class="content_header_td">启用带宽管理？
...
<td class="content_list_header_td" width="60%" id="x_QRuleList">下载策略列表
...
<table width="666" border="2" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_list_header_tr">
<td class="content_list_header_td" width="60%" id="x_UQRuleList">上传策略列表
...
<table class="content_list_value_table" border="1" cellspacing="0" cellpadding="0">
<tr>
<td></td><td class="content_list_field_header_td" colspan="">端口	                
