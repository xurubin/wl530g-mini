...
<td class="content_header_td_title" colspan="2">无线 - 访问控制</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">「访问控制」（Access Control）可让您以封锁来自某些无线工作站的访问，或仅忽略来自某些无线工作站的访问。在「接受」（Accept）模式下，ZVMODELVZ只可接受来自控制列表中所列含有MAC地址之工作站的无线访问。在「拒绝」（Reject）模式下，ZVMODELVZ将会拒绝来自控制列表中所有含有MAC地址工作站的无线访问。
         </td>
</tr>
<tr>
...
<td class="content_list_header_td" width="60%" id="ACLList">访问控制列表
