    ...
    if (b == " Add ")
    {
        ...
        else if (s=='x_FUserList')
    	{
    	    if (document.form.usb_ftpnum_x_0.value >= c) cFlag=1;
            	...
            	!validate_range(document.form.usb_ftpmaxuser_x_0, 0, 12)) return false;
...
function load_body()
{
   ...
   {
   	wl_rate_change();
   	if (window.top.isModel()!="WL520" && window.top.isModel()!="SnapAP" && window.top.isModel()!="WL300")
   	{
   ...
   {  	
   	if (document.form.wan_proto_t.value != "Automatic IP")
   	{
...
function wl_rate_change()
{
	orig = document.form.wl_rate.value;
   	...
   	{    
   	     vitems = new Array("0", "1000000", "2000000", "5500000", "6000000", "11000000", "12000000", "18000000", "24000000", "36000000", "48000000", "54000000");
   	     items = new Array("Auto", "1", "2", "5.5", "6", "11", "12", "18", "24", "36", "48", "54");             
        }   
        else
        {
