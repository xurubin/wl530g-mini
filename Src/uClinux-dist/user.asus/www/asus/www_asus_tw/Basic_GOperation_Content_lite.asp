...
<tr>
<td class="content_desc_td" colspan="2" height="50">
ZVMODELVZ支援數種透過其WAN通訊埠連接網際網路的連線方式。請選擇您需要的連線類型。另外，在連上網際網路之前，請確定您已將ZVMODELVZ的WAN通訊埠接上您的DSL（數位用戶迴路）或Cable Modem（纜線數據機）。</td>
</tr>
<tr> 
...
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('本欄可讓您提供ZVMODELVZ所使用的主機名稱。通常是您ISP業者要求的名稱。', LEFT);" onMouseOut="return nd();">主機名稱（Host Name）：</td><td class="content_input_td"><input type="text" maxlength="32" size="32" name="wan_hostname" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hostname"); %>"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('本欄可讓您提供ZVMODELVZ連接網際網路所使用的特有網路卡實體位址（MAC Address）。通常是您ISP業者要求的位址。', LEFT);" onMouseOut="return nd();">網路卡實體位址（MAC Address）：</td><td class="content_input_td"><input type="text" maxlength="12" size="12" name="wan_hwaddr_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hwaddr_x"); %>" onBlur="return validate_hwaddr(this)" onKeyPress="return is_hwaddr()"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('請輸入認證伺服器的名稱或位址。', LEFT);" onMouseOut="return nd();">認證伺服器:</td><td class="content_input_td"><input type="text" maxlength="12" size="32" name="wan_heartbeat_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_heartbeat_x"); %>"></td>
</tr>
<tr>
...
<tr>
<td class="content_desc_td" colspan="2" height="50">請填寫ZVMODELVZ透過WAN通訊埠連結網際網路所使用的TCP/IP設定值。</td>
</tr>
<tr>
