...
<table width="666" border="1" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_section_header_tr">
<td class="content_section_header_td" colspan="2">印表機</td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('連接至ZVMODELVZ的印表機型號。', LEFT);" onMouseOut="return nd();">印表機型號：
...
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('目前印表機狀態', LEFT);" onMouseOut="return nd();">印表機狀態：
...
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('目前使用本台印表機的用戶IP位址。', LEFT);" onMouseOut="return nd();">用戶：
