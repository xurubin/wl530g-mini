    ...
    {  
	   ...
	   if (mode == 'Gateway')
	   {
           ...
           if (isModel()!='SnapAP')     
           {
    	      ...
    	      appendChild(aux1, generateDocEntry(0, "基本設定",  "Advanced_BasicFirewall_Content.asp", ""))    
    	   ...
    	   {
    	       appendChild(aux1, generateDocEntry(0, "MAC存取控制",  "Advanced_MACFilter_Content.asp", ""))
    	   }           
     }
     ...
     {
     	  aux1 = appendChild(foldersTree, leafNode("頻寬管理"))          
           appendChild(aux1, generateDocEntry(0, "基本設定", "Advanced_QOS_Content.asp", ""))           
     }     
     ...
     aux1 = appendChild(foldersTree, leafNode("登出"))  
}
...
function clickOnFolderRec(foldersNode, folderName)
{
    ...
    if (foldersNode[3] == folderName)
    {
        ...
        else
        {
            ...
            if (folderName != '快速安裝' && folderName != '首頁' && folderName != '登出' )
            {
               foldersNode[0] = 1
               foldersNode[1] = 1     
            }   
            else if (isModel() == 'WL550' && folderName == '快速安裝')
            {
               foldersNode[0] = 1
               foldersNode[1] = 1
            }
