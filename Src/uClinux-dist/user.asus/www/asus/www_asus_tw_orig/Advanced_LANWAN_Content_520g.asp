...
<tr>
<td class="content_desc_td" colspan="2">ZVMODELVZ는 여러 방식의 WAN 연결유형을 지원합니다. 이러한 유형은 WAN 연결유형 옆에 있는 드롭다운 메뉴에서 선택할 수 있습니다. 설정 필드항목은 선택한 연결유형에 따라 다릅니다.
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('비활성화를 선택하면 WAN 포트를 비활성화 하고 AP로 ZVMODELVZ를 설정합니다. 활성화를 선택하면 ZVMODELV를 NAT 기능이 있는 라우터로 설정합니다. 자동을 선택하면 부팅동안 이더넷 케이블이 WAN포트에 연결되어 있는 경우 ZVMODELV를 라우터로 설정합니다.', LEFT);" onMouseOut="return nd();">WAN 모드:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('이것은 원격 네트워크에서 나타나는 바와 같이 ZVMODELVZ의 IP주소입니다. 공란으로 두면 ZVMODELVZ가 DHCP 서버로 부터 IP주소를 자동으로 가져옵니다.', LEFT);" onMouseOut="return nd();">IP 주소:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('원격 네트워크에서 나타나는 것과 같은 ZVMODELVZ의 서브넷 마스크입니다', LEFT);" onMouseOut="return nd();">서브넷 마스크:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('ZVMODELVZ와 원격 네트워크 또는 호스트와 연결할 수 있도록 하는 기본설정 게이트웨이의 IP주소입니다.', LEFT);" onMouseOut="return nd();">기본설정 게이트웨이:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('이 필드항목은 ZVMODELVZ와 연결되는 DNS의 IP주소를 나타냅니다.', LEFT);" onMouseOut="return nd();">DNS 서버1:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('이 필드항목은 ZVMODELVZ와 연결되는 DNS의 IP주소를 나타냅니다.', LEFT);" onMouseOut="return nd();">DNS 서버2:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('PPPoE 릴레이는 LAN의 스테이션이 NAT 통과지점인 개별 PPPoE 연결설정을 할 수 있도록 합니다.', LEFT);" onMouseOut="return nd();">PPPoE 릴레이를 활성화합니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 ZVMODELVZ의 호스트 이름을 부여할 수 있습니다. ISP가 보통 요구합니다.', LEFT);" onMouseOut="return nd();">호스트 이름:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 인터넷 연결을 위한 ZVMODELVZ의 MAC 주소를 부여할 수 있습니다. ISP가 보통 요구합니다.', LEFT);" onMouseOut="return nd();">MAC 주소:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('로컬 네트워크에서 보여지는 것과 같은 ZVMODELVZ의 IP주소입니다. 초기설정값은 192.168.1.1입니다.', LEFT);" onMouseOut="return nd();">IP 주소:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('로컬 네트워크에서 보여지는 것과 같은 ZVMODELVZ의 서브넷 마스크입니다. 초기설정값은 255.255.255.0입니다.', LEFT);" onMouseOut="return nd();">서브넷 마스크:
