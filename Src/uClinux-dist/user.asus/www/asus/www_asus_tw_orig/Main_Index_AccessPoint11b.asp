...
<table height="22" width="666">
  ...
  <tr bgcolor="#FFFF00"> 
    <td class="content_desc_td_home"> 
      ...
      <ul>
        <li> 
          <p style="word-spacing: 0; margin-top: 0; margin-bottom: 0"> <a href="javascript:top.openBranch('빠른 설정')"><b>빠른 설정</b></a>질문에 답변만 하여도 사용자가 완전하게 기본설정을 할 수 있습니다.</li>
        <li> <b><a href="javascript:top.openBranch('무선')">802.11b 및WPA</a> &nbsp;</b>최대 11Mbps 전송율과 통합보안기능을 지원합니다.</li>          
        <li> <b><a href="javascript:top.openBranch('상태 & 로그')">상태 & 로그</a></b>시스템 로그정보</li><p> 
