...
<td class="content_header_td_title" colspan="2">인터넷 방화벽 - MAC 필터</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">MAC 필터는 여러분의 LAN에서 지정한 MAC 어드레스를 가진 장비로부터의 패킷을 막을 수 있도록 해줍니다.
         </td>
</tr>
<tr>
<td class="content_header_td">MAC 필터 모드
...
<td class="content_list_header_td" width="60%" id="MFList">MAC 필터 목록
         <input type="hidden" name="macfilter_num_x_0" value="<% nvram_get_x("FirewallConfig", "macfilter_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'MFList', 16, ' Add ');" name="MFList" value="추가" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'MFList', 16, ' Del ');" name="MFList" value="삭제" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="">MAC 어드레스	                
           	        </td><td></td>
</tr>
<tr>
