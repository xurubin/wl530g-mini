...
<table border="1" width="542">
  ...
  <tr>
    ...
    <p><font size="4"><b>입력형식</b></font></p>        
      <p>다음은 ZVMODELVZ의 일반적인 입력형식입니다. 마우스가 각 필드 항목위에 위치하면 그에 관한 정의를 읽을 수 있습니다.</p>            
      <li>
        <b>Source IP 또는 Destination IP</b> : 출발지 및 목적지 IP주소는 "192.168.122.1"와 같은 특정한 IP주소나 "192.168.123.*" 또는 "192.168.*.*"과 같은 동일한 서브넷의 IP주소, "*.*.*.*"와 같이 모든 IP주소를 입력할 수 있습니다.
      </li>       
      <li>
        <b>포트영역</b> : 출발지 및 목적지 포트 영역은 "95"와 같은 특정한 포트나 "103:315", ">100" 또는 "<65535"등의 영역의 포트를 입력할 수 있습니다.
      </li>       
