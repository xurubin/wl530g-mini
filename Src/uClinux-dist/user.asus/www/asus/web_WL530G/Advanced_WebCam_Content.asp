...
<tr>
<td class="content_desc_td" colspan="2">본 기능은 웹 카메라를 통하여 환경을 모니터링할 수 있도록 합니다. 움직임이 탐지되면 WL530G가 이메일로 알려 줍니다.
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 이메일이 수신되는 이메일 서버를 표시합니다. 공란으로 두면 WL530G는 아래의 이메일 주소에서 메일교환기를 찾게 됩니다.', LEFT);" onMouseOut="return nd();">이메일 서버:
