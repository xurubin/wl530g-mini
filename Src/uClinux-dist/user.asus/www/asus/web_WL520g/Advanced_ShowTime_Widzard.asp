<html>
<head>
<title>WL520g Web Camera Page</title>
...
{  
   ...
   {
      rst = confirm("고정 IP를 설정하였으며 URL을 즐겨찾기에 추가하여WAN에서 사용할 수 있도록 하겠습니까?");
   ...
   {
      rst = confirm("DDNS 계정을 설정하였으며 URL을 즐겨찾기에 추가하여WAN에서 사용할 수 있도록 하겠습니까?");
...
<p>  
   ...
   <input class=inputSubmit onClick="addbookmark()" type="button" value="즐겨찾기에 추가합니다." name="action"></font></div> 
</p>
</td>
</tr>
<tr>
<td colspan="2"></td>
<td width="10" style="padding-top:2;padding-bottom:2;padding-left:2" onMouseOver="return overlib('커서를 이미지 영역 위로 움직이고 마우스 왼쪽 버튼을 클릭하여 이미지를 캡쳐합니다. 마우스 오른쪽 버튼을 클릭하여 비디오 녹화를 하고 오른쪽 버튼을 다시 클릭하면 녹화정지합니다.', CENTER, CAPTION, '액티브 사용자를 위한 도움말');" onMouseOut="return nd();">
...
<b>
"ActiveX와 새로고침" 모드를 사용하나 이미지를 볼 수 없으면 다른 방법으로 나타내기 위하여 다음의 링크를 누르십시오.. <a href="javascript:openLink('x_WImageStatic')" name="PrinterStatus_x_WImageStatic_link">here</a>
</b>
</font>
</td>
</tr>
