...
<td class="content_header_td_title" colspan="2">인터넷 방화벽 -  URL 필터</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">URL 필터는 로컬 네트워크로 부터 특정한 URL의 액세스를 블로킹 할 수 있습니다.
         </td>
</tr>
<tr>
<td class="content_header_td">URL 필터를 활성화합니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 URL 필터를 활성화하는 날짜를 정합니다.', LEFT);" onMouseOut="return nd();">URL 필터 활성화 날짜:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 URL 필터를 활성화하는 시간간격을 정합니다.', LEFT);" onMouseOut="return nd();">URL 필터 활성화 시간:
...
<td class="content_list_header_td" width="60%" id="UrlList">URL 키워드 목록
         <input type="hidden" name="url_num_x_0" value="<% nvram_get_x("FirewallConfig", "url_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'UrlList', 128, ' Add ');" name="UrlList" value="추가" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'UrlList', 128, ' Del ');" name="UrlList" value="삭제" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="">URL 키워드	                
           	        </td><td></td>
</tr>
<tr>
