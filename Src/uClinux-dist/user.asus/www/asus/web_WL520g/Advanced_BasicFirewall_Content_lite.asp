...
<tr>
<td class="content_desc_td" colspan="2">방화벽을 사용하면 WL520g과 디바이스 등에 대한 기본적인 보호를 하게 됩니다. 특정한 패킷을 필터링하려면 다음 페이지의 WAN>LAN 필터를 사용하십시오.
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 기능은 인터넷으로 부터 WL520g를 관리할 수 있도록 합니다. 홈 게이트웨이 모드인 경우에는 브라우저 초기설정 포트(80)가 로컬 네트워크내의 웹 서버에 특별히 정하여져 있기 때문에 8080포트(이는 브라우저에서 http://192.168.123.1:8080과 같은 URL을 입력하는 것을 의미합니다.)로 WL520g에 접근하십시오.', LEFT);" onMouseOut="return nd();">WAN으로 부터의 웹 접근을 활성화하겠습니까?
