...
<tr>
<td class="content_header_td" onMouseOver="return overlib('별도의 무선 로컬 네트워크에서 보이는 WL520g의 IP주소입니다.', LEFT);" onMouseOut="return nd();">IP주소:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('별도의 무선 로컬 네트워크에서 보이는 WL520g의 서브넷 마스크입니다.', LEFT);" onMouseOut="return nd();">서브넷 마스크:
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
</table>
</td>
