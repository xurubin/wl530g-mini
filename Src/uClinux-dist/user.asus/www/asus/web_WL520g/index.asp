...
function logout()
{
   if (confirm(' 이 항목에서 Logout을 원하시면, "OK"를 누르고 이 구성창이 닫히는지 확인 하십시오.'))
   {
   	location="Logout.asp"; 	
   }   
}
    ...
    {  
	   ...
	   if (mode == 'Gateway')
	   {
           ...
           if (isModel()!='SnapAP')     
           {
    	      ...
    	      appendChild(aux1, generateDocEntry(0, "기본 컨피규레이션",  "Advanced_BasicFirewall_Content.asp", ""))    
    	   ...
    	   {
    	       appendChild(aux1, generateDocEntry(0, "MAC 필터",  "Advanced_MACFilter_Content.asp", ""))
    	   }           
     }
     ...
     if (isModel() == 'WL500' && isFlash() != '2MB' && mode!='AP')
     {
           ...
           appendChild(aux1, generateDocEntry(0, "기본 컨피규레이션", "Advanced_QOS_Content.asp", ""))           
     }
...
function clickOnFolderRec(foldersNode, folderName)
{
    ...
    if (foldersNode[3] == folderName)
    {
        ...
        else
        {
            ...
            if (folderName != '빠른 설정' && folderName != '홈' && folderName != 'Logout' )
            {
               foldersNode[0] = 1
               foldersNode[1] = 1     
            }   
            else if (isModel() == 'WL550' && folderName == '빠른 설정')
            {
               foldersNode[0] = 1
               foldersNode[1] = 1
            }
