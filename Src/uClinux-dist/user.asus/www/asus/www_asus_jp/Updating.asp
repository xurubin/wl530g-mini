  ...
  <tr bgcolor="#CCCCCC"> 
    <td width="666" height="125"> 
      <table width="660" height="125" cellpadding="2" cellspacing="0" border="0">
        <tbody> 
        <tr> 
          <td bgcolor="#FF0000" height="50" width="652"><b><font size="5" face="Arial" color="#FFFFFF">ファームウェアをアップグレードしています。</font></b></td>
        </tr>
        <tr> 
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial">システムがアップグレード中です。ZVMODELVZ設定のホームページが再表示されるまでお待ちください。</font></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td width="652" height="25" bgcolor="#FFFFFF" colspan="2"><font face="Arial"> 
            <font color="#FF0000"><b>注意：８０秒かかります。</b></font></font></td>
        </tr>
        </tbody> 
      </table>
    </td>
