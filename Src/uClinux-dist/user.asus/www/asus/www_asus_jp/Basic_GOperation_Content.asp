...
<div align="center">
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toPrevTag('Country')" type="hidden" value="前へ" name="action1"></font>&nbsp;&nbsp;
<font face="Arial"> <input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toTag('Country')" type="button" value="次へ" name="action"></font>
</div>
</td>
</tr>
...
<tr class="content_section_header_tr">
<td class="content_section_header_td" colspan="2">インターネット接続タイプの選択</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2" height="50">
ZVMODELVZはそのWANポートを通してインターネットへの2種類の接続をサポートします。必要とする接続タイプを選択してください。さらに、インターネットに接続する前に、ZVMODELVZのWANポートをお使いのDSLまたはケーブルモデム接続していることを確認してください。</td>
</tr>
<tr> 
          <td class="content_header_td_less" onMouseOut="return nd();" colspan="2">          
          <p></p>
          <p><input type="radio" checked name="x_WANType" value="1" class="content_input_fd" onClick="changeWANType()">IPを自動的に取得するケーブルモデム、またはその他の接続タイプ。</p>          
          <p><input type="radio" checked name="x_WANType" value="2" class="content_input_fd" onClick="changeWANType()">ユーザーネイムとパスワードを要求するADSL接続。PPPoEとして知られています。</p>          
          <p><input type="radio" checked name="x_WANType" value="3" class="content_input_fd" onClick="changeWANType()">ユーザーネイム、パスワードとIPアドレスを要求するADSL接続。PPTPとして知られています。</p>          
          <p><input type="radio" checked name="x_WANType" value="4" class="content_input_fd" onClick="changeWANType()">スタティックIPアドレスを使用するADSLまたはその他の接続タイプ。</p>
          <p><input type="radio" checked name="x_WANType" value="5" class="content_input_fd" onClick="changeWANType()">Telstra BigPondケーブルモデムサービス。</p>
          <p></p>
          <p></p>
          </td>
</tr>
...
<div align="center">
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toPrevTag('Broadband')" type="button" value="前へ" name="action"></font>&nbsp;&nbsp;
<font face="Arial"> <input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toTag('Broadband')" type="button" value="次へ" name="action"></font>
</div>
</td>
</tr>
<tr><td colspan="2" height="360"></td></tr>
...
<tr class="content_section_header_tr">
<td  class="content_section_header_td" colspan="2">アカウントをISPに設定</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2" height="50">ADSLアカウントをダイナミックIPに適用する場合、ADSLアカウントをダイナミックIPに適用する場合、ISPからアカウントとパスワードを取得する必要があります。このデータを次のフィールドに注意して記入してください。または、ADSLアカウントをスタティックIPに適用する場合、ユーザー名とパスワード情報を無視してください。</td>
</tr>
<tr>
<td class="content_header_td_less">ユーザー名:</td><td class="content_input_td"><input type="text" maxlength="64" size="32" name="wan_pppoe_username" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_pppoe_username"); %>"></td>
</tr>
<tr>
<td class="content_header_td_less">パスワード:</td><td class="content_input_td"><input type="password" maxlength="64" size="32" name="wan_pppoe_passwd" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_pppoe_passwd"); %>"></td>
</tr>
<tr>
<td class="content_input_td" colspan="2">
<table>
...
<td>
<div align="center">
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toPrevTag('PPPoE')" type="button" value="前へ" name="action"></font>&nbsp;&nbsp;
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toTag('PPPoE')" type="button" value="次へ" name="action"></font>
</div>
</td>
</tr>
<tr><td colspan="2" height="360"></td></tr>
...
<tr class="content_section_header_tr">
<td  class="content_section_header_td" colspan="2">ISPが要求する情報を記入</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2" height="50">ISPはユーザーアカウントを確認するために次の情報を要求します。要求されなければ、[次へ]を押してそれを無視してください。</td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('このフィールドは、ZVMODELVZに対してホスト名を提供します。ホスト名は通常ISPにより要求されます。', LEFT);" onMouseOut="return nd();">ホスト名:</td><td class="content_input_td"><input type="text" maxlength="32" size="32" name="wan_hostname" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hostname"); %>"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('このフィールドは、ZVMODELVZに対して固有MACアドレスを提供してインターネットに接続します。MACアドレスは通常ISPにより要求されます。', LEFT);" onMouseOut="return nd();">MACアドレス:</td><td class="content_input_td"><input type="text" maxlength="12" size="12" name="wan_hwaddr_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hwaddr_x"); %>" onBlur="return validate_hwaddr(this)" onKeyPress="return is_hwaddr()"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('BigPondサービスの認証サーバーのサーバー名またはサーバーipを入力してください。', LEFT);" onMouseOut="return nd();">Heart-Beatサーバー:</td><td class="content_input_td"><input type="text" maxlength="32" size="32" name="wan_heartbeat_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_heartbeat_x"); %>"></td>
</tr>
<tr>
...
<td>
<div align="center">
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toPrevTag('MacHost')" type="button" value="前へ" name="action"></font>&nbsp;&nbsp;
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toTag('MacHost')" type="button" value="次へ" name="action"></font>
</div>
</td>
</tr>
<tr><td colspan="2" height="360"></td></tr>
...
<tr class="content_section_header_tr">
<td class="content_section_header_td" colspan="2">WAN IP設定</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2" height="50">ZVMODELVZに対してTCP/IP設定を入力し、WANポートを通してインターネットに接続します。</td>
</tr>
<tr>
<td class="content_header_td_less">IPを自動的に取得しますか?</td><td class="content_input_td"><input type="radio" value="1" name="x_DHCPClient" class="content_input_fd" onClick="changeDHCPClient()">Yes</input><input type="radio" value="0" name="x_DHCPClient" class="content_input_fd" onClick="changeDHCPClient()">No</input></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('WANインターフェイスのIPアドレス。これをブランクにしておくと、ZVMODELVZはDHCPサーバーからIPアドレスを自動的に取得します。', LEFT);" onMouseOut="return nd();">IP Address:</td><td class="content_input_td"><input type="text" maxlength="15" size="15" name="wan_ipaddr" class="content_input_fd" value="<% nvram_get_x("IPConnection","wan_ipaddr"); %>" onBlur="return validate_ipaddr(this, 'wan_ipaddr')" onKeyPress="return is_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td_less">サブネットマスク:</td><td class="content_input_td"><input type="text" maxlength="15" size="15" name="wan_netmask" class="content_input_fd" value="<% nvram_get_x("IPConnection","wan_netmask"); %>" onBlur="return validate_ipaddr(this)" onKeyPress="return is_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td_less">デフォルトのゲートウェイ:</td><td class="content_input_td"><input type="text" maxlength="15" size="15" name="wan_gateway" class="content_input_fd" value="<% nvram_get_x("IPConnection","wan_gateway"); %>" onBlur="return validate_ipaddr(this)" onKeyPress="return is_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td_less">DNSサーバーを自動的に取得しますか?</td><td class="content_input_td"><input type="radio" value="1" name="wan_dnsenable_x" class="content_input_fd" onClick="changeDNSServer()" <% nvram_match_x("IPConnection","wan_dnsenable_x", "1", "checked"); %>>Yes</input><input type="radio" value="0" name="wan_dnsenable_x" class="content_input_fd" onClick="changeDNSServer()" <% nvram_match_x("IPConnection","wan_dnsenable_x", "0", "checked"); %>>No</input></td>
</tr>
<tr>
<td class="content_header_td_less">DNSサーバー1:</td><td class="content_input_td"><input type="text" maxlength="15" size="15" name="wan_dns1_x" class="content_input_fd" value="<% nvram_get_x("IPConnection","wan_dns1_x"); %>" onBlur="return validate_ipaddr(this)" onKeyPress="return is_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td_less">DNSサーバー2:</td><td class="content_input_td"><input type="text" maxlength="15" size="15" name="wan_dns2_x" class="content_input_fd" value="<% nvram_get_x("IPConnection","wan_dns2_x"); %>" onBlur="return validate_ipaddr(this)" onKeyPress="return is_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_input_td" colspan="2">
<table>
...
<td width="444" height="100"></td><td>
<div align="center">
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toPrevTag('WANSetting')" type="button" value="前へ" name="action"></font>&nbsp;&nbsp;
<font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toTag('WANSetting')" type="button" value="次へ" name="action"></font>
</div>
</td>
</tr>
<tr><td colspan="2" height="360"></td></tr>
...
<tr bgcolor="#FFFFFF">  
   ...
   <td height="25" width="33%">  
   <div align="center">
   <font face="Arial"><input class=inputSubmit onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="toPrevTag('Wireless')" type="button" value="前へ" name="action"></font>&nbsp;&nbsp;&nbsp;&nbsp;
