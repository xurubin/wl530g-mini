...
<td class="content_header_td_title" colspan="2">ステータスとログ - システムログ</td>
</tr>
<tr class="content_header_tr">
...
<tr bgcolor="#FFFFFF">  
   ...
   <div align="center"><font face="Arial"> <input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="document.form1.next_host.value = location.host; onSubmitCtrl(this, ' Clear ')" type="submit" value="消去" name="action"></font></div> 
   </form>
   </td>
   <td height="25" width="33%">  
   <form method="get" name="form2" action="syslog.cgi">   
   <input type="hidden" name="next_host" value="">
   <div align="center"><font face="Arial"> <input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="document.form2.next_host.value = location.host; onSubmitCtrl(this, ' Save ')" type="submit" value="保存" name="action"></font></div> 
   </form>
   </td>
   <td height="25" width="33%">
   ...
   <input type="hidden" name="next_host" value="">
   <div align="center"><font face="Arial"> <input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="document.form3.next_host.value = location.host; onSubmitCtrl(this, ' Refresh ')" type="submit" value="リフレッシュ" name="action"></font></div> 
   </form>
   </td>
</tr>
</table>
