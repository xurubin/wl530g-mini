...
<tr>
<td class="content_desc_td" colspan="2">LAN対WANフィルタにより、LANとWAN間で指定されたパケットをブロックできます。まず、フィルタが有効になる日時を定義できます。次に、両方の方向のフィルタに対して既定の動作を選択し、例外に対する規則を挿入できます。
         </td>
</tr>
...
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LWFilterList', 16, ' Add ');" name="LWFilterList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LWFilterList', 16, ' Del ');" name="LWFilterList" value="削除" size="12">
</div>
</td><td width="10%">
<div align="center">
