...
<tr>
<td class="content_header_td" onMouseOver="return overlib('無効を選択するとWANポートが無効になり、APとしてZVMODELVZを設定します。有効を選択するとZVMODELVZをNAT機能を持つルータとして設定します。自動を選択すると、イーサネットケーブルが起動中にWANポートに接続されているとき、ルータとしてZVMODELVZを設定します。', LEFT);" onMouseOut="return nd();">WANモード:
