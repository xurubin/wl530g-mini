...
function generateTree()
    ...
    aux1 = appendChild(foldersTree, leafNode("ホーム"))  
    aux1 = appendChild(foldersTree, leafNode("クイック設定"))                
    //if (mode == 'AP')
    //{
    ...
    //}       
    	   aux1 = appendChild(foldersTree, leafNode("ワイヤレス"))
           if (isModel() == 'WL600')    
           {      
              appendChild(aux1, generateDocEntry(0, "インターフェイス", "Advanced_Wireless_Content.asp", ""))
              appendChild(aux1, generateDocEntry(0, "t2AES", "Advanced_UniqueKey_Content.asp", ""))
              appendChild(aux1, generateDocEntry(0, "アクセスコントロール", "Advanced_ACL_Content.asp",  ""))
           }   
           else
           {
              appendChild(aux1, generateDocEntry(0, "インターフェイス", "Advanced_Wireless_Content.asp", ""))               
              //appendChild(aux1, generateDocEntry(0, "Certificate", "Advanced_WCertificate_Content.asp", ""))
              appendChild(aux1, generateDocEntry(0, "ブリッジ", "Advanced_WMode_Content.asp", ""))              
              appendChild(aux1, generateDocEntry(0, "アクセスコントロール", "Advanced_ACL_Content.asp",  ""))
              appendChild(aux1, generateDocEntry(0, "RADIUS設定", "Advanced_WSecurity_Content.asp", ""))             
              appendChild(aux1, generateDocEntry(0, "詳細設定", "Advanced_WAdvanced_Content.asp", ""))              
           }   
    
    if (mode == 'AP')
    {   
    aux1 = appendChild(foldersTree, leafNode("IP較正"))            
           appendChild(aux1, generateDocEntry(0, "LAN", "Advanced_APLAN_Content.asp", ""))                      
    }       
    else if (mode == 'Gateway')
    {  
    aux1 = appendChild(foldersTree, leafNode("IP較正"))            
           appendChild(aux1, generateDocEntry(0, "WANとLAN", "Advanced_LANWAN_Content.asp", ""))                                     
           appendChild(aux1, generateDocEntry(0, "PPPoE セッション", "Advanced_MultiPPPoE_Content.asp", ""))                                     
           appendChild(aux1, generateDocEntry(0, "DHCPサーバー", "Advanced_DHCP_Content.asp", "")) 
           appendChild(aux1, generateDocEntry(0, "スタティックルート", "Advanced_GWStaticRoute_Content.asp", ""))            
           appendChild(aux1, generateDocEntry(0, "その他", "Advanced_DDNS_Content.asp", ""))          

    aux1 = appendChild(foldersTree, leafNode("NAT設定"))   
    	   //if (isModel() == 'WL300')                             
    	   //	appendChild(aux1, generateDocEntry(0, "ポートトリガ",  "Advanced_PortMapping_Content.asp", ""))                  
    	   //else	
    	   appendChild(aux1, generateDocEntry(0, "ポートトリガ",  "Advanced_PortTrigger_Content.asp", ""))            
           appendChild(aux1, generateDocEntry(0, "仮想サーバー",  "Advanced_VirtualServer_Content.asp", ""))      
           appendChild(aux1, generateDocEntry(0, "仮想DMZ",  "Advanced_Exposed_Content.asp", ""))  
            
    aux1 = appendChild(foldersTree, leafNode("インターネットファイアウォール"))    	  
           appendChild(aux1, generateDocEntry(0, "WANとLANフィルタ",  "Advanced_Firewall_Content.asp", ""))  
           appendChild(aux1, generateDocEntry(0, " URLフィルタ",  "Advanced_URLFilter_Content.asp", ""))
           //appendChild(aux1, generateDocEntry(0, "WAN & ZVMODELVZ Filter",  "Advanced_LFirewall_Content.asp", ""))      
           
    if (isModel() != 'WL300')    
    {          
       aux1 = appendChild(foldersTree, leafNode("ワイヤレスファイアウォール"))
           appendChild(aux1, generateDocEntry(0, "基本構成",  "Advanced_DMZIP_Content.asp", ""))                           
           appendChild(aux1, generateDocEntry(0, "DHCPサーバー", "Advanced_DMZDHCP_Content.asp", ""))
	   appendChild(aux1, generateDocEntry(0, "WLANとWANフィルタ",  "Advanced_DMZDWFilter_Content.asp", ""))                                                                                          
           appendChild(aux1, generateDocEntry(0, "WLANとLANフィルタ",  "Advanced_DMZDLFilter_Content.asp", ""))                                                                                                                            
    }       
    ...
    {
    aux1 = appendChild(foldersTree, leafNode("IP較正"))            
           appendChild(aux1, generateDocEntry(0, "WANとLAN", "Advanced_RLANWAN_Content.asp", ""))                          
           appendChild(aux1, generateDocEntry(0, "DHCPサーバー", "Advanced_RDHCP_Content.asp", "")) 
           appendChild(aux1, generateDocEntry(0, "その他", "Advanced_RMISC_Content.asp", ""))                          
                   
    aux1 = appendChild(foldersTree, leafNode("ルータ"))     
           appendChild(aux1, generateDocEntry(0, "スタティックルート",  "Advanced_StaticRoute_Content.asp", ""))
           appendChild(aux1, generateDocEntry(0, "ダイナミックルート", "Advanced_DynamicRoute_Content.asp", ""))             
    ...
    aux1 = appendChild(foldersTree, leafNode("インターネットファイアウォール"))               
     ...
     {
    	 aux1 = appendChild(foldersTree, leafNode("USBアプリケーション"))          
           appendChild(aux1, generateDocEntry(0, "FTPサーバー", "Advanced_USBStorage_Content.asp", ""))
           appendChild(aux1, generateDocEntry(0, "Webカメラ", "Advanced_WebCam_Content.asp", ""))
     }      
    
     aux1 = appendChild(foldersTree, leafNode("システムセットアップ"))          
     appendChild(aux1, generateDocEntry(0, "操作モード", "Advanced_OperationMode_Content.asp", "")) 
     appendChild(aux1, generateDocEntry(0, "パスワードの変更", "Advanced_Password_Content.asp",""))
     appendChild(aux1, generateDocEntry(0, "ファームウェアのアップグレード", "Advanced_FirmwareUpgrade_Content.asp", ""))
     appendChild(aux1, generateDocEntry(0, "管理の設定", "Advanced_SettingBackup_Content.asp", ""))
     appendChild(aux1, generateDocEntry(0, "出荷時設定", "Advanced_FactoryDefault_Content.asp", ""))
     //appendChild(aux1, generateDocEntry(0, "Printer Setup", "Advanced_PrinterSetup_Content.asp", ""))
    
    if (mode=='AP')
    {
       aux1 = appendChild(foldersTree, leafNode("ステータスとログ"))
           appendChild(aux1,generateDocEntry(0, "ステータス", "Main_AStatus_Content.asp", ""))          
           appendChild(aux1,generateDocEntry(0, "ワイヤレス", "Main_WStatus_Content.asp", ""))
           //appendChild(aux1,generateDocEntry(0, "システムログ", "Main_LogStatus_Content.asp", ""))
    }
    else if (mode=='Gateway')
    {
       aux1 = appendChild(foldersTree, leafNode("ステータスとログ"))
           appendChild(aux1,generateDocEntry(0, "ステータス", "Main_GStatus_Content.asp", ""))          
           appendChild(aux1,generateDocEntry(0, "ワイヤレス", "Main_WStatus_Content.asp", ""))         
           appendChild(aux1,generateDocEntry(0, "DHCPリース", "Main_DHCPStatus_Content.asp", "")) 
           appendChild(aux1,generateDocEntry(0, "ポート転送", "Main_IPTStatus_Content.asp", ""))                    
           appendChild(aux1, generateDocEntry(0, "経路指定表", "Advanced_RouteStatus_Content.asp", ""))              
           appendChild(aux1,generateDocEntry(0, "システムログ", "Main_LogStatus_Content.asp", ""))
    }
    else if (mode=='Router')
    {
       aux1 = appendChild(foldersTree, leafNode("ステータスとログ"))
           appendChild(aux1,generateDocEntry(0, "ステータス", "Main_RStatus_Content.asp", ""))      
           appendChild(aux1,generateDocEntry(0, "ワイヤレス", "Main_WStatus_Content.asp", ""))
           appendChild(aux1,generateDocEntry(0, "DHCPリース", "Main_DHCPStatus_Content.asp", ""))            
           appendChild(aux1, generateDocEntry(0, "経路指定表", "Advanced_RouteStatus_Content.asp", ""))   
           appendChild(aux1,generateDocEntry(0, "システムログ", "Main_LogStatus_Content.asp", ""))              
...
function clickOnFolderRec(foldersNode, folderName)
{
    ...
    if (foldersNode[3] == folderName)
    {
        ...
        else
        {
            ...
            if (folderName != 'クイック設定' && folderName != 'ホーム')
            {
               foldersNode[0] = 1
               foldersNode[1] = 1     
            }   
