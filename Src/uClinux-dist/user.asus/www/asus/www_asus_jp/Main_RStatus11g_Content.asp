...
<td class="content_section_header_td" colspan="2">WANステータス</td>
</tr>
<tr>
<td class="content_header_td_less">WANタイプ:
...
<tr>
<td class="content_header_td_less">ゲートウェイ:
...
<tr>
<td class="content_header_td_less">DNSサーバー:
...
<tr>
<td class="content_header_td_less">リンクステータス:
