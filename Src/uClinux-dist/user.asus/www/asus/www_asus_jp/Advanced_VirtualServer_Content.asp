...
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'VSList', 24, ' Add ');" name="VSList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'VSList', 24, ' Del ');" name="VSList" value="削除" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="">ポート範囲	                
           	        </td><td class="content_list_field_header_td" colspan="">ローカルIP	                
           	        </td><td class="content_list_field_header_td" colspan="">Local Port	                
           	        </td><td class="content_list_field_header_td" colspan="">プロトコル	                
           	        </td><td class="content_list_field_header_td" colspan="">プロトコル番号	                
