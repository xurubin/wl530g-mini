  ...
  <tr bgcolor="#FFFFFF"> 
    <td width="420" height="125"> 
      <table width="420" height="125" border="0" cellpadding="0" cellspacing="0" border="0">
        <tbody> 
        <tr> 
          <td bgcolor="#FFFFFF" height="50" colspan="2"><b><font size="5" face="Arial" color="#FF0000">インターネット接続ステータス</font></b></td>
        </tr>
        <tr>
	   <td height="30"><font face="Arial" color="#000000">タイプ</font></td>
	...
	<tr>
	   <td height="30"><font face="Arial" color="#000000">ステータス:</font></td>
	...
	<tr>
	   <td height="30"><font face="Arial" color="#000000">理由</font></td>
	...
	<tr> 
        ...
        <tr>           
          ...
          <p><input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver=buttonOver(this) type="button" onClick="redirect()" value="ログイン" name="action"></p>
          </td>
        </tr>             
        </tbody> 
      </table>
