...
<td class="content_header_td_title" colspan="2">インターネットファイアウォール - MACフィルタ</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">MACフィルタは、LANに指定されたMACアドレスを持つデバイスからパケットをブロックします。
         </td>
</tr>
<tr>
<td class="content_header_td">MACフィルタモード:
...
<td class="content_list_header_td" width="60%" id="MFList">MACフィルタリスト
         <input type="hidden" name="macfilter_num_x_0" value="<% nvram_get_x("FirewallConfig", "macfilter_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'MFList', 16, ' Add ');" name="MFList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'MFList', 16, ' Del ');" name="MFList" value="削除" size="12">
</div>
</td><td width="5%"></td>
</tr>
