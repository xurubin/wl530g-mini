...
function logout()
{
   if (confirm('このセッションをログアウトする場合、"OK"を押し、この構成ウィンドウが閉じていることを確認してください。'))
   {
   	location="Logout.asp"; 	
   }   
}
    ...
    {  
	   ...
	   if (mode == 'Gateway')
	   {
           ...
           if (isModel()!='SnapAP')     
           {
    	      ...
    	      appendChild(aux1, generateDocEntry(0, "基本的なコンフィグ",  "Advanced_BasicFirewall_Content.asp", ""))    
    	   ...
    	   {
    	       appendChild(aux1, generateDocEntry(0, "MACフィルタ",  "Advanced_MACFilter_Content.asp", ""))
    	   }           
     }
     ...
     {
     	  aux1 = appendChild(foldersTree, leafNode("QoS"))          
           appendChild(aux1, generateDocEntry(0, "基本的なコンフィグ", "Advanced_QOS_Content.asp", ""))           
     }     
     ...
     aux1 = appendChild(foldersTree, leafNode("ログアウト"))  
}
...
function clickOnFolderRec(foldersNode, folderName)
{
    ...
    if (foldersNode[3] == folderName)
    {
        ...
        else
        {
            ...
            if (folderName != 'クイック設定' && folderName != 'ホーム' && folderName != 'ログアウト' )
            {
               foldersNode[0] = 1
               foldersNode[1] = 1     
            }   
            else if (isModel() == 'WL550' && folderName == 'クイック設定')
            {
               foldersNode[0] = 1
               foldersNode[1] = 1
            }
