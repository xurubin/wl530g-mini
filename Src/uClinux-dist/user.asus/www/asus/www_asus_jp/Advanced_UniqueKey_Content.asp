...
<td class="content_header_td_title" colspan="2">ワイヤレス - t2AES</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">AESキー制御により、それぞれの802.11aワイヤレスクライアントに対して固有暗号化キーを保持することができます。まず「ワイヤレス - インターフェイス」ページでAES暗号化を有効にするのを忘れないでください。
         </td>
</tr>
...
<td class="content_list_header_td" width="60%" id="AESList"> AES アクセスコントロールリスト(11aのみ)
         <input type="hidden" name="AESListCount_0" value="<% nvram_get_x("DeviceSecurity11a", "AESListCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'AESList', 64, ' Add ');" name="AESList" value="追加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'AESList', 64, ' Del ');" name="AESList" value="削除" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<td></td><td class="content_list_field_header_td" colspan="">MACアドレス	                
           	        </td><td class="content_list_field_header_td" colspan="">AESタイプ	                
           	        </td><td class="content_list_field_header_td" colspan="">AESキー	                
           	        </td><td></td>
</tr>
<tr>
