...
<table height="22" width="666">
  ...
  <tr bgcolor="#FFFF00"> 
    <td class="content_desc_td_home"> 
      ...
      <ul>
        <li> 
          <p style="word-spacing: 0; margin-top: 0; margin-bottom: 0"> <a href="javascript:top.openBranch('快速安装')"><b>快速安装</b></a>只须回答几个问题，便可让用户完成基本设置。</li>
        <li> <b><a href="javascript:top.openBranch('无线')">802.11b和WPA</a> &nbsp;</b>可支持最高11Mbps传输速率及及跨平台的安全强化。</li>          
        <li> <b><a href="javascript:top.openBranch('状态及历史记录')">状态及历史记录</a></b>详细记录系统的状态。</li><p> 
