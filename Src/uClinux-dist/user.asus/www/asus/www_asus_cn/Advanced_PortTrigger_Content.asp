...
<tr>
<td class="content_desc_td" colspan="2">「端口触发」功能可让您以开启特定的TCP或UDP端口来与连接ZVMODELVZ的电脑进行通讯。而通过指定触发程序端口号及向内端口号的方式即可完成此一操作。一旦侦测到该触发程序端口相应的端口号，送往指定向内端口的入站封包便会转向您的电脑。
         </td>
</tr>
<tr>
