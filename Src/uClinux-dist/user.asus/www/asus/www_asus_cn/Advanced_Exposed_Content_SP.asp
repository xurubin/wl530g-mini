...
<td class="content_header_td_title" colspan="2">NAT设置 - 虚拟DMZ</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">虚拟DMZ（Virtual DMZ）可让您将一台电脑在互联网上公开，使所有上传的封包全部转向您指定的电脑。这对您在执行一些使用非特定的向内端口（incoming port）的应用程序时会相当有用。请谨慎使用。
         </td>
</tr>
<tr>
<td class="content_header_td">公开工作站的IP地址：
...
<td class="content_section_header_td" colspan="2">特殊应用程序
            </td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">某些应用程序需要特殊的处理程序来对抗NAT。请填入可启用该种应用的相关参数。
         </td>
</tr>
<tr>
