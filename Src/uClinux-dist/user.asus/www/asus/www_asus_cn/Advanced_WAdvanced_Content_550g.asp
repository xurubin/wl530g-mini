...
<tr>
<td class="content_header_td" onMouseOver="return overlib('WLANConfig11b_x_RadioPowerEx_itemdesc', LEFT);" onMouseOut="return nd();">功率输出（Radio Power）：
</td>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此选项让你能够激活或关闭WMM。', LEFT);" onMouseOut="return nd();">激活 WMM?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此选项让你能够激活或关闭WMM No-Acknowledgment.', LEFT);" onMouseOut="return nd();">激活 WMM No-Acknowledgement？
