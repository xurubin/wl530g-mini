...
<td class="content_header_td_title" colspan="2">状态及历史记录 - 系统历史记录</td>
</tr>
<tr class="content_header_tr">
...
<tr bgcolor="#FFFFFF">  
   ...
   <div align="center"><font face="Arial"> <input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="document.form1.next_host.value = location.host; onSubmitCtrl(this, ' Clear ')" type="submit" value="清除" name="action"></font></div> 
   </form>
   </td>
   ...
   <input type="hidden" name="next_host" value="">
   <div align="center"><font face="Arial"> <input class=inputSubmit onMouseOut=buttonOut(this) onMouseOver="buttonOver(this)" onClick="document.form3.next_host.value = location.host; onSubmitCtrl(this, ' Refresh ')" type="submit" value="刷新" name="action"></font></div> 
   </form>
   </td>
</tr>
</table>
