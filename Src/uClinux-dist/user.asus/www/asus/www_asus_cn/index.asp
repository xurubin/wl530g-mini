...
function generateTree()
    ...
    {      
          ...
          appendChild(aux1, generateDocEntry(0, "访问控制", "Advanced_ACL_Content.asp",  ""))
    }
    ...
    {  
	   ...
	   if (mode == 'Gateway')
	   {
           ...
           if (isModel()!='SnapAP')     
           {
    	      ...
    	      appendChild(aux1, generateDocEntry(0, "基本设置",  "Advanced_BasicFirewall_Content.asp", ""))    
    	   ...
    	   {
    	       appendChild(aux1, generateDocEntry(0, "MAC访问控制",  "Advanced_MACFilter_Content.asp", ""))
    	   }           
     }
     ...
     {
     	  aux1 = appendChild(foldersTree, leafNode("带宽管理"))          
           appendChild(aux1, generateDocEntry(0, "基本设置", "Advanced_QOS_Content.asp", ""))           
     }     
     ...
     if (isModel() != 'WL520' && isModel() != 'SnapAP')
     {
     	...
     	appendChild(aux1, generateDocEntry(0, "修改密码", "Advanced_Password_Content.asp",""))
     	...
     	appendChild(aux1, generateDocEntry(0, "出厂默认值", "Advanced_FactoryDefault_Content.asp", ""))
     }	
     else
     {
     	//appendChild(aux1, generateDocEntry(0, "操作模式", "Advanced_OperationMode_Content.asp", "")) 
     ...
     else
     {
        aux1 = appendChild(foldersTree, leafNode("状态及历史记录"))
           ...
           appendChild(aux1,generateDocEntry(0, "无线", "Main_WStatus_Content.asp", ""))         
           appendChild(aux1,generateDocEntry(0, "DHCP租约记录", "Main_DHCPStatus_Content.asp", "")) 
           if (isModel() != 'SnapAP')
           {
              appendChild(aux1,generateDocEntry(0, "端口转发", "Main_IPTStatus_Content.asp", ""))                    
...
function clickOnFolderRec(foldersNode, folderName)
{
    ...
    if (foldersNode[3] == folderName)
    {
        ...
        else
        {
            ...
            if (folderName != '快速安装' && folderName != '主页' && folderName != '登出' )
            {
               foldersNode[0] = 1
               foldersNode[1] = 1     
            }   
            else if (isModel() == 'WL550' && folderName == '快速安装')
            {
               foldersNode[0] = 1
               foldersNode[1] = 1
            }
