...
<tr>
<td class="content_desc_td" colspan="2">LAN to WAN过滤可让您封锁LAN与WAN之间的指定封包。首先，您可定出过滤器将会启用的日期及时间。接着，您可选择过滤器在两种方向所适用的预设动作，并插入适合任何例外条件的规则。
         </td>
</tr>
...
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LWFilterList', 16, ' Add ');" name="LWFilterList" value="增加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LWFilterList', 16, ' Del ');" name="LWFilterList" value="删除" size="12">
</div>
</td><td width="10%">
<div align="center">
