...
<td class="content_header_td_title" colspan="2">IP 컨피규레이션 - 라우터</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">본 기능은 라우팅 규칙을 ZVMODELVZ로 추가할 수 있도록 합니다. ZVMODELVZ의 라우터들을 연결하여 인터넷에서 동일한 연결을 공유할 경우에 유용합니다.
         </td>
</tr>
<tr>
<td class="content_header_td">라우팅표에 적용합니까?
...
<td class="content_list_header_td" width="60%" id="GWStatic">고정 라우터 목록
         <input type="hidden" name="sr_num_x_0" value="<% nvram_get_x("RouterConfig", "sr_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'GWStatic', 6, ' Add ');" name="GWStatic" value="추가" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'GWStatic', 6, ' Del ');" name="GWStatic" value="삭제" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'GRouterHelp');" name="GWStatic" value="도움말" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<td></td><td class="content_list_field_header_td" colspan="">네트워크/호스트IP	                
           	        </td><td class="content_list_field_header_td" colspan="">넷마스크	                
           	        </td><td class="content_list_field_header_td" colspan="">게이트웨이	                
           	        </td><td class="content_list_field_header_td" colspan="">메트릭	                
           	        </td><td class="content_list_field_header_td" colspan="">인터페이스	                
           	        </td><td></td>
</tr>
<tr>
