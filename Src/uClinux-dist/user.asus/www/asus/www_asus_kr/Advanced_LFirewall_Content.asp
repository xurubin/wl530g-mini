...
<tr>
<td class="content_desc_td" colspan="2">WAN>ZVMODELVZ 필터는 WAN과 ZVMODELVZ간의 패킷을 블로킹할 수 있도록 합니다. 우선 양방향 필터의 초기설정 액션을 선택할 수 있습니다. 그리고 난 후 예외에 해당하는 규칙을 삽입합니다.
         </td>
</tr>
<tr>
<td class="content_header_td">WAN>ZVMODELVZ 필터를 활성화합니까?
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 WAN>ZVMODELVZ 필터를 활성화하는 날짜를 정합니다.', LEFT);" onMouseOut="return nd();">WAN>ZVMODELVZ 필터 활성화 날짜:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 WAN>ZVMODELVZ필터를 활성화하는 시간간격을 정합니다.', LEFT);" onMouseOut="return nd();">WAN>ZVMODELVZ 필터 활성화 시간:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 WAN>ZVMODELVZ필터 테이블에서 정하여지지 않은 WAN>ZVMODELVZ패킷의 드롭여부를 정의합니다.', LEFT);" onMouseOut="return nd();">정하여 지지 않은 패킷(WAN>ZVMODELVZ):
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 필터링될 WAN>ZVMODELVZ ICMP패킷의 목록을 정의합니다. 예를 들면 에코(유형 8)와 에코 응답(유형 0)  ICMP 패킷을 필터링하려면 0 5와 같이 띄어쓰기한 숫자의 문자열을 입력해야 합니다.', LEFT);" onMouseOut="return nd();">필터링된 ICMP(WAN>ZVMODELVZ) 패킷유형:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목은 ZVMODELVZ와 WAN간의 로그 될 패킷 유형을 나타냅니다.', LEFT);" onMouseOut="return nd();">ZVMODELVZ와 WAN간의 로그 유형:
...
<td class="content_list_header_td" width="60%" id="WLocalFilterList">WAN > ZVMODELVZ 필터 테이블
