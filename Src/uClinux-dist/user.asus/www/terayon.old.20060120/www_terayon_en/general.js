...
function load_wizard()
{
   ...
   {
       rst = confirm("Thanks for purchasing the Wireless Router. Do you want to start Quick Setup directly?");
       if (rst)        
       {       	   
...
function load_body()
{
   ...
   else if (document.form.current_page.value == "Advanced_WAdvanced_Content.asp") 
   {
   	...
   	if (window.top.isModel()!="WL520" && window.top.isModel()!="SnapAP" && window.top.isModel()!="WL300" && window.top.isCard()!='ralink')
   	{
   ...
   {   	   	
   	...
   	if (window.top.isModel()!="SnapAPOrig")
   	{
   		change_wan_type(document.form.wan_proto.value);
        	...
        	{     		
			document.form.wan_mode_x.options[3].value = null;
			document.form.wan_mode_x.options[3] = null;			  	
		}	
        }	
...
function change_common(o, s, v)
{
  ...
  {	   			
 	...
 	else change_wireless_bridge(o.value, rcheck(document.form.wl_wdsapply_x), 1, 1);
  }
  else if (v=="wan_proto")
  {
...
function change_common_radio(o, s, v, r)
{
  ...
  if (v=='wl_wdsapply_x')
  {
  	...
  	else change_wireless_bridge(document.form.wl_mode_x.value, r, 1, 0);
  }
