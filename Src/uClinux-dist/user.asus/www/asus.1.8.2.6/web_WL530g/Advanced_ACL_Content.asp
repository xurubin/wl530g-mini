...
<tr>
<td class="content_desc_td" colspan="2">「存取控制」（Access Control）可让您以封锁来自某些无线工作站的存取，或仅忽略来自某些无线工作站的存取。在「接受」（Accept）模式下，WL530g只可接受来自控制列表中所列含有MAC地址之工作站的无线存取。在「拒绝」（Reject）模式下，WL530g将会拒绝来自控制列表中所有含有MAC地址工作站的无线存取。
         </td>
</tr>
<tr>
