...
WL530g支持三种可满足不同需求的操作模式。请选择符合您现状的模式。
</td>
</tr>
<tr>
<td class="content_header_td_30"><input type="radio" name="x_Mode"> 家用网关</td>
<td class="content_desc_td">
在此种模式中，我们建议您使用WL530g通过ADSL或Cable Modem来连接互联网。同时，在您的环境中许多人都可共享同一IP来使用ISP。
<p></p>
...
<td class="content_desc_td">
在「路由器」模式中，我们建议您使用WL530g来连接您公司内部的局域网（LAN）。现在，您可设置路由通讯协议以符合您的办公环境需求。
<p></p>
从专业术语的角度解释，路由器模式是 - 可设置取消网络地址转换（NAT），允许设置静态路由通讯协议。
</td>
</tr>
<tr>
...
<p></p>
从专业术语的角度解释，AP接入点模式是 - 关闭网络地址转换（NAT），允许将WL530g的一组互联网端口（WAN port）与四组局域网端口（LAN port）桥接在一起。
</td>
</tr>
<tr>
