...
<td class="content_desc_td" colspan="2" width="614">
                  <p style="margin-top: 7">本项功能可让您将目前的WL530g的设置保存成文件，或从文件中载入设置。
</td>
</tr>
...
<p style="margin-top: 7"> 
                 请将您的光标移到文件上。 <a href="/WL530g.CFG">HERE</a>. 接着点选鼠标右键并选择<b>「另存为....」</b>将目前WL530g的设置保存成文件。（注：在您将目前的设置保存成文件时，亦同样会存入闪存内。）
