...
<td class="content_desc_td" colspan="2" width="614">
              ...
              <p style="margin-top: 7">
                    请将下载文件的路径及名称指定到「新固件文件」中。
              		...
              		<li>
              <p style="margin-top: 7">
                    点选「上传」将文件上传至 WL530g。整个过程需时约10秒钟。
              </li>
              <li>
              <p style="margin-top: 7">
                    在收到正确的固件文件后，WL530g即自动开始升级的过程。整个过程需要一些时间来完成，接着系统将会重新开机。
 	      </li>
              </ol>
</td>
</tr>
...
<td class="content_header_td"></td><td class="content_input_td" width="595">
  <p align="left"><input class="inputSubmit" onClick="onSubmitCtrlOnly(this, 'Upload')" type="submit" value="上传"> 
  </p>
</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2" width="614">
	             <b>注意：</b>
                     <ol>
                     	...
                     	<li>当升级过程失败，WL530g会自动进入紧急模式。而WL530g正面上的LED指示灯会指示此种情况。请使用光盘上的「固件恢复」（Firmware Restoration）公用程序进行系统还原操作。</li>
                     </ol>
</td>
</tr>
</table>
