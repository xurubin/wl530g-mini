...
<tr>
<td class="content_desc_td" colspan="2">WLAN vs. LAN过滤器可让您在「无线防火墙」启用时，封锁WLAN 与 LAN之间的指定封包。首先，您可在两种方向之中选择适合过滤器的预设动作。接着，插入适用任何例外条件的规则。
         </td>
</tr>
<tr>
<td class="content_header_td">启用WLAN vs. LAN过滤器？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义那些在「从WLAN 到 LAN过滤器表」中未加指定，即将接受或丢弃的从WLAN 到 LAN封包。', LEFT);" onMouseOut="return nd();">未指定的封包（从WLAN 到 LAN）有：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义一个从WLAN 到 LAN ICMP封包类型将会过滤的列表。例如，假设您想过滤Echo（类型8）及Echo Reply（类型0）的ICMP封包，那您必须输入一组含有数字但以空格隔开的字串，例如0 5。', LEFT);" onMouseOut="return nd();">过滤后的ICMP（从WLAN到LAN）封包类型：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义一些在「从LAN 到 WLAN过滤器表」中未加指定，即将接受或丢弃的从LAN 到 WLAN封包。', LEFT);" onMouseOut="return nd();">未指定的封包（从LAN 到 WLAN）有：
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'FirewallConfig', '')"><option class="content_input_fd" value="DROP" <% nvram_match_x("FirewallConfig","", "DROP","selected"); %>>DROP</option><option class="content_input_fd" value="ACCEPT" <% nvram_match_x("FirewallConfig","", "ACCEPT","selected"); %>>ACCEPT</option></select></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义一个从LAN 到 WLAN ICMP封包类型将会过滤的列表。例如，假设您想过滤Echo（类型8）及Echo Reply（类型0）的ICMP封包，那您必须输入一组含有数字但以空格隔开的字串，例如0 5。', LEFT);" onMouseOut="return nd();">过滤后的ICMP(从LAN 到 WLAN)封包类型：
           </td><td class="content_input_td"><input type="text" maxlength="32" class="content_input_fd" size="32" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_portlist(this, '')" onKeyPress="return is_portlist(this)"></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义WLAN 与LAN之间将会记录的封包种类。', LEFT);" onMouseOut="return nd();">WLAN与LAN之间的记录类型：
...
<td class="content_list_header_td" width="60%" id="DLFilterList">从WLAN 到 LAN过滤表
         <input type="hidden" name="DmzLanRuleCount_0" value="<% nvram_get_x("FirewallConfig", "DmzLanRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DLFilterList', 32, ' Add ');" name="DLFilterList" value="增加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DLFilterList', 32, ' Del ');" name="DLFilterList" value="删除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="DLFilterList" value="说明" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<table width="666" border="2" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_list_header_tr">
<td class="content_list_header_td" width="60%" id="LDFilterList">从LAN 到 WLAN过滤表
         <input type="hidden" name="LanDmzRuleCount_0" value="<% nvram_get_x("FirewallConfig", "LanDmzRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LDFilterList', 32, ' Add ');" name="LDFilterList" value="增加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'LDFilterList', 32, ' Del ');" name="LDFilterList" value="删除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="LDFilterList" value="说明" size="12">
</div>
</td><td width="5%"></td>
</tr>
<table class="content_list_table" width="640" border="0" cellspacing="0" cellpadding="0">
