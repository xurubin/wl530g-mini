...
<tr>
<td class="content_desc_td" colspan="2">「启用防火墙」功能可为WL530g及在其之后的装置提供基本的保护。如果您要过滤出一些特定的封包，请采用将在下页中提到的WAN vs. LAN过滤。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您通过互联网来管理WL530g。如果您现在处理「家用网关」的模式，请通过8080端口来存取WL530g（亦即请在您的浏览器中输入URL，例如http://192.168.123.1:8080）。因为此浏览器（80）的预设端口是专为您本地网络中的Web服务器所保留的。', LEFT);" onMouseOut="return nd();">从互联网设置WL530g？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目为让您指定用来通过互联网存取Web服务器的端口。', LEFT);" onMouseOut="return nd();">从互联网设置WL530g所使用的端口：
