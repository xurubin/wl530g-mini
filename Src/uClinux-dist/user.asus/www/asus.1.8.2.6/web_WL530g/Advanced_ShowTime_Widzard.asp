...
{  
   ...
   {
      rst = confirm("您已设置好静态IP，您要将此URL加到收藏夹，好让您能从WAN网络上来使用它吗？");
   ...
   {
      rst = confirm("您已设置好一个DDNS帐号，您要将此URL加到收藏夹，好让您能从WAN网络上来使用它吗？");
...
<p>  
   ...
   <input class=inputSubmit onClick="addbookmark()" type="button" value="「加到收藏夹」" name="action"></font></div> 
</p>
</td>
</tr>
<tr>
<td colspan="2"></td>
<td width="10" style="padding-top:2;padding-bottom:2;padding-left:2" onMouseOver="return overlib('将光标移至影像区上，点选鼠标左键以抓取影像。点选鼠标右键可录制影片，再点选右键即可停止录制。', CENTER, CAPTION, 'Active User的专属小技巧');" onMouseOut="return nd();">
...
<b>
如果您是使用「ActiveX及更新」模式，却仍然看不到任何影像，请按以下连接采另外方式显示。. <a href="javascript:openLink('x_WImageStatic')" name="PrinterStatus_x_WImageStatic_link">here</a>
</b>
</font>
</td>
</tr>
