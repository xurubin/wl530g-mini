...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此WL530g的IP地址与您在此分离式无线本地网络中所见的相同。', LEFT);" onMouseOut="return nd();">IP地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此WL530g的「子网掩码」与您在此分离式无线本地网络中所见的相同。', LEFT);" onMouseOut="return nd();">子网掩码：
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
</table>
</td>
