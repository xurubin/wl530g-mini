...
<tr>
<td class="content_desc_td" colspan="2" height="50">
WL530g支持数种通过其WAN端口连接互联网的连接方式。请选择您需要的连接类型。另外，在连上互联网之前，请确定您已将WL530g的WAN端口接上您的DSL（数字用户线路）或Cable Modem（电缆调制解调器）。</td>
</tr>
<tr> 
...
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('本栏目可让您提供WL530g所使用的主机名称。通常是您ISP要求的名称。', LEFT);" onMouseOut="return nd();">主机名称（Host Name）：</td><td class="content_input_td"><input type="text" maxlength="32" size="32" name="wan_hostname" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hostname"); %>"></td>
</tr>
<tr>
<td class="content_header_td_less" onMouseOver="return overlib('本栏目可让您提供WL530g连接互联网所使用的特有MAC（媒体访问控制）地址。通常是您ISP要求的地址。', LEFT);" onMouseOut="return nd();"> MAC（媒体访问控制） 地址：</td><td class="content_input_td"><input type="text" maxlength="12" size="12" name="wan_hwaddr_x" class="content_input_fd" value="<% nvram_get_x("PPPConnection","wan_hwaddr_x"); %>" onBlur="return validate_hwaddr(this)" onKeyPress="return is_hwaddr()"></td>
</tr>
<tr>
...
<tr>
<td class="content_desc_td" colspan="2" height="50">请填写WL530g通过WAN端口连接互联网所使用的TCP/IP设置。</td>
</tr>
<tr>
