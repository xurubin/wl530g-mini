...
<tr>
<td class="content_desc_td" colspan="2">WL530G는 여러 방식의 WAN 연결유형을 지원합니다. 이러한 유형은 WAN 연결유형 옆에 있는 드롭다운 메뉴에서 선택할 수 있습니다. 설정 필드항목은 선택한 연결유형에 따라 다릅니다.
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('이 필드항목은 WL530G와 연결되는 DNS의 IP주소를 나타냅니다.', LEFT);" onMouseOut="return nd();">DNS 서버1:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('이 필드항목은 WL530G와 연결되는 DNS의 IP주소를 나타냅니다.', LEFT);" onMouseOut="return nd();">DNS 서버2:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 WL530G의 호스트 이름을 부여할 수 있습니다. ISP가 보통 요구합니다.', LEFT);" onMouseOut="return nd();">호스트 이름:
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('본 필드항목에서는 인터넷 연결을 위한 WL530G의 MAC 주소를 부여할 수 있습니다. ISP가 보통 요구합니다.', LEFT);" onMouseOut="return nd();">MAC 주소:
