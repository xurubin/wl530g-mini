...
<td class="content_header_td_title" colspan="2">IP设置 - 路径</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">本项功能可让您将路由规则加到ZVMODELVZ之中。如果您将多个路由器连接在ZVMODELVZ之后，以共享同一互联网连接，这是相当有用的。
         </td>
</tr>
<tr>
<td class="content_header_td">应用静态路径列表？
...
<td class="content_list_header_td" width="60%" id="GWStatic">静态路由列表
         <input type="hidden" name="sr_num_x_0" value="<% nvram_get_x("RouterConfig", "sr_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'GWStatic', 6, ' Add ');" name="GWStatic" value="增加" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'GWStatic', 6, ' Del ');" name="GWStatic" value="删除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'GRouterHelp');" name="GWStatic" value="说明" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<td></td><td class="content_list_field_header_td" colspan="">网络/主机IP	                
           	        </td><td class="content_list_field_header_td" colspan="">网络掩码	                
           	        </td><td class="content_list_field_header_td" colspan="">网关	                
           	        </td><td class="content_list_field_header_td" colspan="">顺序	                
           	        </td><td class="content_list_field_header_td" colspan="">界面	                
           	        </td><td></td>
</tr>
<tr>
