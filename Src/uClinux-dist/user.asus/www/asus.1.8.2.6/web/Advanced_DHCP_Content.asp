...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了您LAN网络中网关的IP地址。如果您空着不填，便会指定为ZVMODELVZ的IP地址。', LEFT);" onMouseOut="return nd();">预设网关：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了提供给用户端向DHCP服务器要求IP地址的域名的IP地址。您可以空着不填，那么DNS要求便会交由ZVMODELVZ处理。', LEFT);" onMouseOut="return nd();">DNS服务器1：
