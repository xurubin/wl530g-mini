...
<table border="1" width="542">
  ...
  <tr>
    ...
    <p><font size="4"><b>输入格式</b></font></p>        
      <p>下列为ZVMODELVZ中一般的输入类型，当鼠标移到每个栏目上时，您可了解其真正的定义。</p>            
      <li>
        <b>来源IP或目的IP</b> : 在来源或目的IP地址方面，您可输入特定的IP地址，如「192.168.122.1」，或在子网内的IP地址，如「192.168.123.*」、或"192.168.*.*"，或像是「*.*.*.*」这样所有的IP地址。
      </li>       
      <li>
        <b>端口范围</b> : 在来源或目的通讯端口的范围方面，您可输入特定端口，如「95」，或在某个范围内的通讯端口，如「103:315」、「>100」或是「<65535」。
      </li>       
