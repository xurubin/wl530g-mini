...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此为预设网关的IP地址，可使ZVMODELVZ与远程网络或主机之间相互连系。', LEFT);" onMouseOut="return nd();">预设网关：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一栏目可显示ZVMODELVZ所连接的DNS的IP地址。', LEFT);" onMouseOut="return nd();">DNS服务器1：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一栏目可显示ZVMODELVZ所连接的DNS的IP地址。', LEFT);" onMouseOut="return nd();">DNS服务器2：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可让您提供ZVMODELVZ连接互联网所使用的特有MAC（媒体访问控制）地址。通常是您ISP要求的地址。', LEFT);" onMouseOut="return nd();"> MAC（媒体访问控制）地址：
