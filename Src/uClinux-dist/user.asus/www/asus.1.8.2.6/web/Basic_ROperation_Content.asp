...
<tr>
<td class="content_desc_td" colspan="2" height="50">
ZVMODELVZ支持数种通过其WAN端口连接互联网的连接方式。请选择您需要的连接类型。另外，在连上互联网之前，请确定您已将ZVMODELVZ的WAN端口接上您的DSL（数字用户线路）或Cable Modem（电缆调制解调器）。</td>
</tr>
<tr> 
...
<tr>
<td class="content_desc_td" colspan="2" height="50">请填写ZVMODELVZ通过WAN端口连接互联网所使用的TCP/IP设置。</td>
</tr>
<tr>
