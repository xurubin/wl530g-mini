...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您通过互联网来管理ZVMODELVZ。如果您现在处理「家用网关」的模式，请通过8080端口来存取ZVMODELVZ（亦即请在您的浏览器中输入URL，例如http://192.168.123.1:8080）。因为此浏览器（80）的预设端口是专为您本地网络中的Web服务器所保留的。', LEFT);" onMouseOut="return nd();">从互联网设置ZVMODELVZ？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目为让您指定用来通过互联网存取Web服务器的端口。', LEFT);" onMouseOut="return nd();">从互联网设置ZVMODELVZ所使用的端口：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您通过互联网来回应LPR要求。', LEFT);" onMouseOut="return nd();">从互联网回应LPR要求？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您通过互联网来回应Ping要求（ping request）。', LEFT);" onMouseOut="return nd();">从互联网回应PING要求？
