...
<tr>
<td class="content_desc_td" colspan="2">要从您所在网络中的服务器对网外用户提供WWW、FTP等网络服务时，您应该先要指定一个连接服务器的本地IP地址。接着，将IP地址及网络通讯协议的类型、端口编号及网络服务名称增加到下列的列表之中。以此列表为前题，网关会将网络服务要求从网外用户转递给相应的本地服务器。
         </td>
</tr>
<tr>
...
<td></td><td class="content_list_field_header_td" colspan="">本地IP	                
           	        ...
           	        </td><td class="content_list_field_header_td" colspan="">通讯协议编号	                
