...
<tr>
<td class="content_desc_td" colspan="2">WLAN vs. WAN過濾程式讓您可在「無線防火牆」啟用時，加以封鎖WLAN與WAN之間的指定封包。首先，您可選擇過濾程式在兩種方向之中適用的預設動作。接著，插入適合任何例外條件的規則。
         </td>
</tr>
<tr>
<td class="content_header_td">啟用WLAN vs. WAN過濾程式？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄為指定一些在「WLAN to WAN過濾程式表」中未加指定，即將接受或丟棄的WLAN to WAN封包。', LEFT);" onMouseOut="return nd();">未指定的封包（WLAN to WAN）有：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出一張WLAN to WAN ICMP封包類型將會過濾的清單。例如，假設您想過濾Echo（類型8）及Echo Reply（類型0）的ICMP封包，那您必須輸入一組含有數字但以空格隔開的字串，例如0 5。', LEFT);" onMouseOut="return nd();">過濾後的ICMP（WLAN to WAN）封包類型：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出一些在「WAN to WLAN過濾程式表」中未加指定，即將接受或丟棄的WLAN to WAN封包。', LEFT);" onMouseOut="return nd();">未指定的封包（WAN to WLAN）有：
           </td><td class="content_input_td"><select name="" class="content_input_fd" onChange="return change_common(this, 'FirewallConfig', '')"><option class="content_input_fd" value="DROP" <% nvram_match_x("FirewallConfig","", "DROP","selected"); %>>DROP</option><option class="content_input_fd" value="ACCEPT" <% nvram_match_x("FirewallConfig","", "ACCEPT","selected"); %>>ACCEPT</option></select></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出一張WAN to WLAN ICMP封包類型將會過濾的清單。例如，假設您想過濾Echo（類型8）及Echo Reply（類型0）的ICMP封包，那您必須輸入一組含有數字但以空格隔開的字串，例如0 5。', LEFT);" onMouseOut="return nd();">過濾後的ICMP（WAN to WLAN)封包類型：
           </td><td class="content_input_td"><input type="text" maxlength="32" class="content_input_fd" size="32" name="" value="<% nvram_get_x("FirewallConfig",""); %>" onBlur="return validate_portlist(this, '')" onKeyPress="return is_portlist(this)"></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('本欄可定出WLAN與WAN之間將會記錄的封包種類。', LEFT);" onMouseOut="return nd();">WLAN與WAN之間的記錄類型：
...
<td class="content_list_header_td" width="60%" id="DWFilterList">WLAN to WAN過濾表
         <input type="hidden" name="DmzWanRuleCount_0" value="<% nvram_get_x("FirewallConfig", "DmzWanRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DWFilterList', 32, ' Add ');" name="DWFilterList" value="新增" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'DWFilterList', 32, ' Del ');" name="DWFilterList" value="刪除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="DWFilterList" value="說明" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<table width="666" border="2" cellpadding="0" cellspacing="0" bordercolor="E0E0E0">
<tr class="content_list_header_tr">
<td class="content_list_header_td" width="60%" id="WDFilterList">WAN to WLAN過濾表
         <input type="hidden" name="WanDmzRuleCount_0" value="<% nvram_get_x("FirewallConfig", "WanDmzRuleCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'WDFilterList', 32, ' Add ');" name="WDFilterList" value="新增" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'WDFilterList', 32, ' Del ');" name="WDFilterList" value="刪除" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="button" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return openHelp(this, 'FilterHelp');" name="WDFilterList" value="說明" size="12">
</div>
</td><td width="5%"></td>
</tr>
<table class="content_list_table" width="640" border="0" cellspacing="0" cellpadding="0">
