...
<tr>
<td class="content_header_td" onMouseOver="return overlib('將「靜態路由表」（Static Route List）裏所指定靜態路由項目當中的路由資訊，重新分配到RIP表內。', LEFT);" onMouseOut="return nd();">將靜態路由重新分配到RIP（路由資訊協定）內？
