...
<td class="content_desc_td" colspan="2" width="614">
                  <p style="margin-top: 7">本項功能讓您可將目前ZVMODELVZ的設定值存成檔案，或從檔案中載入設定值。
</td>
</tr>
...
<p style="margin-top: 7"> 
                 請將您的游標移到檔案上。 <a href="/ZVMODELVZ.CFG">HERE</a>. 接著點選滑鼠右鍵並選擇<b>「另存目標....」</b>將目前ZVMODELVZ的設定值存成檔案。（註：在您將目前的設定值存成檔案時，亦同樣會存入快閃記憶體內。）
...
<td class="content_desc_td" colspan="2" width="614">                           		                                     		
              <p style="margin-top: 7">
              請將下載檔案的路徑及名稱指定到下方的<b>「新設定檔」</b>中。接著，點選<b>「上傳」</b> 將檔案寫入ZVMODELVZ。整個過程需要一些時間來完成，然後系統將會重新開機。            
</td>
</tr>
<tr>
