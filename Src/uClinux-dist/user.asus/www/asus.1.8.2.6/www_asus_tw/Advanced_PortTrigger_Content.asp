...
<td class="content_header_td_title" colspan="2">NAT設定 - 通訊埠觸發程式</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">「通訊埠觸發程式」功能讓您可以開啟特定的TCP或UDP通訊埠來與連接ZVMODELVZ的電腦進行通訊。而藉由指定觸發程式通訊埠及內傳通訊埠的方式即可完成此一操作。一旦偵測到觸發程式通訊埠，送往指定內傳通訊埠號的上傳封包便會轉向您的電腦。
         </td>
</tr>
<tr>
<td class="content_header_td">啟用通訊埠觸發程式？
...
<td class="content_list_header_td" width="60%" id="TriggerList">觸發程式通訊埠清單
         <input type="hidden" name="autofw_num_x_0" value="<% nvram_get_x("IPConnection", "autofw_num_x"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'TriggerList', 10, ' Add ');" name="TriggerList" value="新增" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'TriggerList', 10, ' Del ');" name="TriggerList" value="刪除" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="3">知名應用程式：         
...
<tr>
<td></td><td class="content_list_field_header_td" colspan="">觸發程式通訊埠	                
           	        </td><td class="content_list_field_header_td" colspan="">通訊協定	                
           	        </td><td class="content_list_field_header_td" colspan="">內傳通訊埠	                
           	        </td><td class="content_list_field_header_td" colspan="">通訊協定	                
