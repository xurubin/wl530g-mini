...
<td class="content_header_td_title" colspan="2">無線 - t2AES</td>
</tr>
<tr>
<td class="content_desc_td" colspan="2">「AES金鑰控制」（AES Key Control）讓您可以專為每個802.11a無線客戶端保有一道特有的加密金鑰。請記得先啟用在「無線 – 介面」（Wireless - Interface）頁中的AES加密功能。
         </td>
</tr>
...
<td class="content_list_header_td" width="60%" id="AESList">AES存取控制清單（僅適用於11a）
         <input type="hidden" name="AESListCount_0" value="<% nvram_get_x("DeviceSecurity11a", "AESListCount"); %>" readonly="1"></td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'AESList', 64, ' Add ');" name="AESList" value="新增" size="12">
</div>
</td><td width="10%">
<div align="center">
<input class="inputSubmit" type="submit" onMouseOut="buttonOut(this)" onMouseOver="buttonOver(this)" onClick="return markGroup(this, 'AESList', 64, ' Del ');" name="AESList" value="刪除" size="12">
</div>
</td><td width="5%"></td>
</tr>
...
<td></td><td class="content_list_field_header_td" colspan="">MAC位址	                
           	        </td><td class="content_list_field_header_td" colspan="">AES類型	                
           	        </td><td class="content_list_field_header_td" colspan="">AES金鑰	                
           	        </td><td></td>
</tr>
<tr>
