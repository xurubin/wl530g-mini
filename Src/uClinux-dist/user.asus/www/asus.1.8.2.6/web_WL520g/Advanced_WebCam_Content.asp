...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了您所使用的网络相机模式。选择「ActiveX Only」可让您在IE平台上执行ActiveX用户端软件以取得最佳的影像品质。选择「ActiveX and Refresh」可让您在IE平台上执行ActiveX用户端软件并在其他浏览器上的检视基本影像。选择「Refresh Only」可让您在所有的浏览器上检视基本影像。', LEFT);" onMouseOut="return nd();">网络相机模式：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目为您所希望的影像大小。', LEFT);" onMouseOut="return nd();">影像大小：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了影像动作可被侦测的感应度（sense level）。', LEFT);" onMouseOut="return nd();">感应度：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目说明了以秒计算的，系统重新载入影像所需的时间间隔。数值的范围是1~65535。', LEFT);" onMouseOut="return nd();">以秒计算的更新时间：
...
<tr>
<td class="content_desc_td" colspan="2">本项功能可让您通过网络相机来监控您的操作环境。如果测到任何动作，WL520g会尝试以电子邮件来警告您。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指出了您想要传送电子邮件目的电子邮件服务器。如果您将本栏目保持空白，WL520g将会从下方的电子邮件帐号当中去搜索「邮件交换主机（Mail Exchanger）。', LEFT);" onMouseOut="return nd();">电子邮件服务器：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可让您将测到的影像文件附加到电子邮件当中。', LEFT);" onMouseOut="return nd();">附加影像文件？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('选择「仅适用于LAN」，您只能在LAN操作环境内进行监控。如果您想从互联网上进行监控，请以手动方式对虚拟服务器列表的http端口及activex进行设置。请考虑安全问题。', LEFT);" onMouseOut="return nd();">远端控制模式：
