...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本项功能可让您指定远端服务器来记录与WL520g有关的记录信息。如果您空着不填，系统仅会在WL520g上记载最多为1024道的信息。', LEFT);" onMouseOut="return nd();">远端记录服务器（Remote Log Server）：
