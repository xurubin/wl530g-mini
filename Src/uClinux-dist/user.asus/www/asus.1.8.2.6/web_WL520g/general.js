...
function onSubmit()
{
   ...
   else if (document.form.current_page.value == "Advanced_LANWAN_Content.asp")
   {
        if (document.form.wan_proto.value == "Static IP")
  	{
  	    ...
  	    {    
  	       alert("当您将IP或子网掩码栏目保留空白，连接类型即会设置为「自动IP」!");
...
{   
   ...
   {      	   	
   	...
   	if (action.value == "Set")
   	{
   	   ...
   	   {
   		alert("当您将IP或子网掩码栏目保留空白，连接类型即会设置为「自动IP」!1");	
   	   	return false;	
   	   }	   	     	   
   	}
...
{   	      	   	   	
   if (v == "wl_wpa_psk")
   {
   	...
   	{   	   
   	   if (o.value.length < 8)
   	   {	
   	      alert("WPA密钥不得超出7个字符!!!如果您将本栏目保留空白，系统将会指定00000000作为您的通行码。");
