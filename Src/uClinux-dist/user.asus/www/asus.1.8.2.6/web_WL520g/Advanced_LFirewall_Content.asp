...
<tr>
<td class="content_desc_td" colspan="2">WAN vs. WL520g过滤器可让您以封锁WAN与WL520g之间的指定封包。首先，您可在两种方向中选择适合过滤器的预设动作。接着，插入适用任何例外条件的规则。
         </td>
</tr>
<tr>
<td class="content_header_td">启用WAN vs. WL520g过滤器？
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义从WAN到 WL520g过滤器将会启用的日期。', LEFT);" onMouseOut="return nd();">从WAN 到WL520g过滤起启用日期：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义从WAN 到 WL520g过滤器将会启用的时间间隔。', LEFT);" onMouseOut="return nd();">从WAN 到 WL520g启用的时间：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义那些在「从WAN 到 WL520g过滤器表」中未加指定，即将接受或丢弃的未指定的从WAN 到 WL520g封包。', LEFT);" onMouseOut="return nd();">未指定的封包（从WAN 到 WL520g）有：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可定义一个从WAN到 WL520g ICMP封包类型将会过滤的列表。例如，假设您想过滤Echo（类型8）及Echo Reply（类型0）的ICMP封包，那您必须输入一组含有数字但以空格隔开的字串，例如0 5。', LEFT);" onMouseOut="return nd();">过滤后的ICMP(从WAN 到 WL520g)封包类型：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可说明WL520g与WAN之间将会记录的封包种类。', LEFT);" onMouseOut="return nd();">WL520g与WAN之间的记录类型：
...
<td class="content_list_header_td" width="60%" id="WLocalFilterList">从WAN 到 WL520g过滤器表
