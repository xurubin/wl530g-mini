...
<tr>
<td class="content_desc_td" colspan="2">WL520g可支持数种连接WAN的连接类型。这些类型可从WAN连接类型旁的下拉式选单中选取。设置栏目会根据您是选取那种连接类型而定。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('选择「停用」，会将WAN端口停用并将WL520g设成是一台AP。选择「启用」，会将WL520g设成是一台含有NAT功能的路由器。在开机期间将以太网络线接上WAN端口时，选择「自动」可将WL520g设成是一台路由器。', LEFT);" onMouseOut="return nd();">WAN模式：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此WL520g的IP地址与您在远程网络上所见相同。如果您空着不填，WL520g会自动向DHCP服务器取得IP地址。', LEFT);" onMouseOut="return nd();">IP地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一WL520g的IP地址与您在远程网络上所见相同。', LEFT);" onMouseOut="return nd();">子网掩码：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此为预设网关的IP地址，可使WL520g与远程网络或主机之间相互连系。', LEFT);" onMouseOut="return nd();">预设网关：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一栏目可显示WL520g所连接的DNS的IP地址。', LEFT);" onMouseOut="return nd();">DNS服务器1：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此一栏目可显示WL520g所连接的DNS的IP地址。', LEFT);" onMouseOut="return nd();">DNS服务器2：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可让您提供WL520g所使用的主机名称。通常是您ISP要求的名称。', LEFT);" onMouseOut="return nd();">主机名称：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目可让您提供WL520g连接互联网所使用的特有MAC（媒体访问控制）地址。通常是您ISP要求的地址。', LEFT);" onMouseOut="return nd();"> MAC（媒体访问控制）地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此WL520g的IP地址与您在本地网络中所见相同。预设值是192.168.1.1。', LEFT);" onMouseOut="return nd();">IP地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('此WL520g的子网掩码与您在本地网络中所见相同。预设值是255.255.255.0。', LEFT);" onMouseOut="return nd();">子网掩码：
