...
<tr>
<td class="content_desc_td" colspan="2">WL520g在「无线防火墙」功能启用时，可支持多达253个IP地址供您的无线网络使用。一台本地设备的IP地址可由网络管理员手动指定或在DHCP服务器启用时，自动从WL520g取得。
         </td>
</tr>
<tr>
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指定了由您无线网络中的DHCP服务器所指定在地址池（pool）中的第一个地址。', LEFT);" onMouseOut="return nd();">IP Pool起始地址：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指定了由您无线网络中的DHCP服务器所指定在地址池（pool）中的最后一个地址。', LEFT);" onMouseOut="return nd();">IP Pool结束地址：
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("LANHostConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指定了允许无线网络用户使用他们目前动态IP地址的全部连接时间。', LEFT);" onMouseOut="return nd();">连线时间：
...
<tr>
<td class="content_header_td" onMouseOver="return overlib('本栏目指定了提供无线用户端向DHCP服务器要求IP地址的域名系统（DNS）的IP地址。您可空着不填，那么DNS要求便会交由WL520g处理。', LEFT);" onMouseOut="return nd();">DNS服务器1：
           </td><td class="content_input_td"><input type="text" maxlength="15" class="content_input_fd" size="15" name="" value="<% nvram_get_x("LANHostConfig",""); %>" onBlur="return validate_ipaddr(this, '')" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)"></td>
</tr>
<tr>
