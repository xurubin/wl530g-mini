...
create_hostapd_conf(void)
{
	...
	if (nvram_match("wl_gmode", "1")) //Auto
	{
		...
		sprintf(oper_rate,"oper_rate=1000,2000,5500,11000,6000,9000,12000,18000,24000,36000,48000,54000\n");		
	}
	...
	else //802.11b
	{
		...
		sprintf(oper_rate,"oper_rate=1000,2000,5500,11000\n");	
