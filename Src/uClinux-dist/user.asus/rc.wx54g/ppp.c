 ...
 *
 * $Id: ppp.c,v 1.3 2006/02/07 09:26:22 Eric1_Liu Exp $
 */
...
//        if ((value = getenv("IPREMOTE")))	{ //Mark by SJ_Yen for L2TP
//		if (nvram_invmatch (strcat_r(prefix, "proto", tmp), "l2tp"))	{	//eric++
			// If l2tp server at WAN side of gateway and WX54G at LAN side of gateway.
			// pppol2tp driver (pppol2tp_xmit()) will fall into infinite loop after new default route was added.
