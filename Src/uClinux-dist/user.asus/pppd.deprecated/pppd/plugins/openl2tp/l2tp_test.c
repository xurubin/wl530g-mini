...
extern int l2tp_xprt_test(__u16 tunnel_id);
...
int l2tp_test_is_fake_rx_drop(__u16 tunnel_id, __u16 session_id)
{
...
int l2tp_test_is_fake_tx_drop(__u16 tunnel_id, __u16 session_id)
{
...
__u16 l2tp_test_alloc_tunnel_id(void)
{
	return ++l2tp_test_data.alloc_tunnel_id;
}

__u16 l2tp_test_alloc_session_id(void)
{
