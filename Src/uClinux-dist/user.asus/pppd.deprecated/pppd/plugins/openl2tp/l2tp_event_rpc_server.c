...
int
_l2tp_session_ppp_updown_ind_1 (l2tp_session_ppp_updown_ind_1_argument *argp, void *result, struct svc_req *rqstp)
{
	return (l2tp_session_ppp_updown_ind_1_svc(argp->tunnel_id, argp->session_id, argp->unit, argp->up, result, rqstp));
}

int
_l2tp_session_ppp_status_ind_1 (l2tp_session_ppp_status_ind_1_argument *argp, void *result, struct svc_req *rqstp)
{
	return (l2tp_session_ppp_status_ind_1_svc(argp->tunnel_id, argp->session_id, argp->result, result, rqstp));
}

int
_l2tp_session_ppp_accm_ind_1 (l2tp_session_ppp_accm_ind_1_argument *argp, void *result, struct svc_req *rqstp)
{
	return (l2tp_session_ppp_accm_ind_1_svc(argp->tunnel_id, argp->session_id, argp->send_accm, argp->recv_accm, result, rqstp));
}
