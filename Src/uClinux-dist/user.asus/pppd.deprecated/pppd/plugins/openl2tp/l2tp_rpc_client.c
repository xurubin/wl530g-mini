...
enum clnt_stat 
l2tp_tunnel_delete_1(uint16_t tunnel_id, optstring tunnel_name, int *clnt_res,  CLIENT *clnt)
{
...
enum clnt_stat 
l2tp_session_delete_1(uint16_t tunnel_id, optstring tunnel_name, uint16_t session_id, optstring session_name, int *clnt_res,  CLIENT *clnt)
{
...
enum clnt_stat 
l2tp_session_incall_ind_1(int ppp_unit, struct l2tp_api_session_msg_data params, char *tunnel_profile_name, int *clnt_res,  CLIENT *clnt)
{
	l2tp_session_incall_ind_1_argument arg;
	arg.ppp_unit = ppp_unit;
	arg.params = params;
	arg.tunnel_profile_name = tunnel_profile_name;
	return (clnt_call (clnt, L2TP_SESSION_INCALL_IND, (xdrproc_t) xdr_l2tp_session_incall_ind_1_argument, (caddr_t) &arg,
		(xdrproc_t) xdr_int, (caddr_t) clnt_res,
		TIMEOUT));
}
