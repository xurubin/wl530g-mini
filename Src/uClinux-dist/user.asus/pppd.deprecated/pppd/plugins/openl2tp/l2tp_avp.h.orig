...
struct l2tp_avp_framing_cap {
	union {
		__u32	X(X(rsvd:30, async:1), sync:1);
		__u32	value;
	};
} __attribute__((packed));
...
struct l2tp_avp_bearer_cap {
	union {
		__u32	X(X(rsvd:30, analog:1), digital:1);
		__u32	value;
	};
} __attribute__((packed));
...
struct l2tp_avp_call_errors {
	__u16	reserved;
	__u32	crc_errors;
	__u32	framing_errors;
	__u32	hardware_overruns;
	__u32	buffer_overruns;
	__u32	timeout_errors;
	__u32	alignment_errors;
} __attribute__((packed));
...
extern struct l2tp_avp_framing_cap 		l2tp_avp_my_framing_cap;
extern struct l2tp_avp_bearer_cap		l2tp_avp_my_bearer_cap;
