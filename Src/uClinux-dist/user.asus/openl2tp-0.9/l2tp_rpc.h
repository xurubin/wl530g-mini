...
#define L2TP_APP_COPYRIGHT_INFO "(c) Copyright 2004,2005"
#define L2TP_APP_VENDOR_INFO "Katalix Systems Ltd."
#define L2TP_APP_MAJOR_VERSION 0
#define L2TP_APP_MINOR_VERSION 9
...
extern  enum clnt_stat l2tp_session_incall_ind_1(int , struct l2tp_api_session_msg_data , int *, CLIENT *);
extern  bool_t l2tp_session_incall_ind_1_svc(int , struct l2tp_api_session_msg_data , int *, struct svc_req *);
