...
typedef int (*encode_fn)(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
			 struct l2tp_msg_info const *msg_info,
			 struct l2tp_tunnel const *tunnel, int hide);
typedef int (*decode_fn)(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);

struct l2tp_avp_info_s {
	int		type;		/* AVP type */
...
typedef struct l2tp_avp_info_s l2tp_avp_info_t;
...
l2tp_avp_firmware_revision_t 	l2tp_avp_my_firmware_revision;
l2tp_avp_host_name_t 		*l2tp_avp_my_host_name;
l2tp_avp_vendor_name_t 		*l2tp_avp_my_vendor_name;
l2tp_avp_protocol_version_t 	l2tp_avp_my_protocol_version;
int					l2tp_avp_my_host_name_len;
int					l2tp_avp_my_vendor_name_len;

static int l2tp_avp_encode_message_type(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					struct l2tp_msg_info const *msg_info,
					struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_message_type(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_result_code(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_result_code(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_protocol_version(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					    struct l2tp_msg_info const *msg_info,
					    struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_protocol_version(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_framing_cap(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_framing_cap(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_bearer_cap(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				      struct l2tp_msg_info const *msg_info,
				      struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_bearer_cap(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_tiebreaker(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_tiebreaker(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_firmware_revision(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					     struct l2tp_msg_info const *msg_info,
					     struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_firmware_revision(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_host_name(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				     struct l2tp_msg_info const *msg_info,
				     struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_host_name(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_vendor_name(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_vendor_name(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_tunnel_id(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				     struct l2tp_msg_info const *msg_info,
				     struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_tunnel_id(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_rx_window_size(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					  struct l2tp_msg_info const *msg_info,
					  struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_rx_window_size(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_challenge(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				     struct l2tp_msg_info const *msg_info,
				     struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_challenge(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_q931_cause_code(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					   struct l2tp_msg_info const *msg_info,
					   struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_q931_cause_code(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_challenge_response(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					      struct l2tp_msg_info const *msg_info,
					      struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_challenge_response(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_session_id(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				      struct l2tp_msg_info const *msg_info,
				      struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_session_id(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_call_serial_number(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					      struct l2tp_msg_info const *msg_info,
					      struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_call_serial_number(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_minimum_bps(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_minimum_bps(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_maximum_bps(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_maximum_bps(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_bearer_type(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_bearer_type(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_framing_type(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					struct l2tp_msg_info const *msg_info,
					struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_framing_type(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_packet_proc_delay(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					     struct l2tp_msg_info const *msg_info,
					     struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_packet_proc_delay(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_called_number(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					 struct l2tp_msg_info const *msg_info,
					 struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_called_number(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_calling_number(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					  struct l2tp_msg_info const *msg_info,
					  struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_calling_number(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_sub_address(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_sub_address(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_tx_connect_speed(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					    struct l2tp_msg_info const *msg_info,
					    struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_tx_connect_speed(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_physical_channel_id(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					       struct l2tp_msg_info const *msg_info,
					       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_physical_channel_id(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_initial_lcp_confreq(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					       struct l2tp_msg_info const *msg_info,
					       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_initial_lcp_confreq(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_last_sent_lcp_confreq(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
						 struct l2tp_msg_info const *msg_info,
						 struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_last_sent_lcp_confreq(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_last_rcvd_lcp_confreq(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
						 struct l2tp_msg_info const *msg_info,
						 struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_last_rcvd_lcp_confreq(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_proxy_auth_type(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					   struct l2tp_msg_info const *msg_info,
					   struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_proxy_auth_type(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_proxy_auth_name(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					   struct l2tp_msg_info const *msg_info,
					   struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_proxy_auth_name(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_proxy_auth_chall(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					    struct l2tp_msg_info const *msg_info,
					    struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_proxy_auth_chall(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_proxy_auth_id(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					 struct l2tp_msg_info const *msg_info,
					 struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_proxy_auth_id(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_proxy_auth_rsp(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					  struct l2tp_msg_info const *msg_info,
					  struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_proxy_auth_rsp(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_call_errors(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				       struct l2tp_msg_info const *msg_info,
				       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_call_errors(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_accm(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
				struct l2tp_msg_info const *msg_info,
				struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_accm(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_random_vector(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					 struct l2tp_msg_info const *msg_info,
					 struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_random_vector(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_priv_group_id(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					 struct l2tp_msg_info const *msg_info,
					 struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_priv_group_id(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_rx_connect_speed(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					    struct l2tp_msg_info const *msg_info,
					    struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_rx_connect_speed(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);
static int l2tp_avp_encode_sequencing_required(void *buffer, int buffer_len, l2tp_avp_desc_t const *data, 
					       struct l2tp_msg_info const *msg_info,
					       struct l2tp_tunnel const *tunnel, int hide);
static int l2tp_avp_decode_sequencing_required(l2tp_avp_hdr_t *hdr, l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel);

static int l2tp_avp_count_avps(l2tp_avp_desc_t *avp_data);
static void l2tp_avp_log_avp(l2tp_avp_hdr_t *avp, struct l2tp_tunnel const *tunnel);
 ...
 */
static const l2tp_avp_info_t l2tp_avp_info[] = 
{
 ...
 */
static int l2tp_avp_hide_unhide(int hide, l2tp_avp_hdr_t *hdr, void *buffer, int buffer_len,
...
static void l2tp_avp_hdr_write(l2tp_avp_hdr_t *hdr, 
			       struct l2tp_msg_info const *msg_info, 
...
static int l2tp_avp_encode_message_type(void *buffer,
					int buffer_len,
					l2tp_avp_desc_t const *data,
					struct l2tp_msg_info const *msg_info,
					struct l2tp_tunnel const *tunnel, int hide)
{
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_message_type_t *avp_data = (void *) &hdr->value[0];
	
	l2tp_avp_hdr_write(hdr, msg_info, TYPE(MESSAGE), sizeof (l2tp_avp_message_type_t), 0);
	avp_data->type = htons(data->value->message_type.type);
	return 0;
}

static int l2tp_avp_decode_message_type(l2tp_avp_hdr_t *hdr,
					l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof (l2tp_avp_message_type_t) + L2TP_AVP_HEADER_LEN)) {
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	...
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_result_code_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_result_code(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
...
{
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_protocol_version_t *avp_data = (void *) &hdr->value[0];
	
	l2tp_avp_hdr_write(hdr, msg_info, TYPE(PROTOCOL_VERSION), sizeof(l2tp_avp_protocol_version_t), 0);
	avp_data->ver = data->value->protocol_version.ver;
	avp_data->rev = data->value->protocol_version.rev;
	return 0;
}

static int l2tp_avp_decode_protocol_version(l2tp_avp_hdr_t *hdr,
					    l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_protocol_version_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_framing_cap_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(FRAMING_CAP), sizeof(l2tp_avp_framing_cap_t), hide);
	avp_data->u.value = htonl(data->value->framing_cap.u.value);
	return result;
}

static int l2tp_avp_decode_framing_cap(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_framing_cap_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
	result->value->framing_cap.u.value = ntohl(result->value->framing_cap.u.value);
	l2tp_tunnel_log(tunnel, L2TP_AVPDATA, LOG_DEBUG, "AVPDATA: FRAMING_CAP: cap=%hu", result->value->framing_cap.u.value);
	return avp_len;
}
				      ...
				      struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_bearer_cap_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(BEARER_CAP), sizeof(l2tp_avp_bearer_cap_t), hide);
	avp_data->u.value = htonl(data->value->bearer_cap.u.value);
	return result;
}

static int l2tp_avp_decode_bearer_cap(l2tp_avp_hdr_t *hdr,
				      l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_bearer_cap_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
	result->value->bearer_cap.u.value = ntohl(result->value->bearer_cap.u.value);
	l2tp_tunnel_log(tunnel, L2TP_AVPDATA, LOG_DEBUG, "AVPDATA: BEARER_CAP: cap=%hu", result->value->bearer_cap.u.value);
	return avp_len;
}
...
{
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_tiebreaker_t *avp_data = (void *) &hdr->value[0];
	
	l2tp_avp_hdr_write(hdr, msg_info, TYPE(TIEBREAKER), sizeof(l2tp_avp_tiebreaker_t), 0);
	memcpy(&avp_data->value[0], &data->value->tiebreaker.value[0], sizeof(l2tp_avp_tiebreaker_t));
	return 0;
}

static int l2tp_avp_decode_tiebreaker(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_tiebreaker_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					     ...
					     struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_firmware_revision_t *avp_data = (void *) &hdr->value[0];

	hdr = buffer;
	l2tp_avp_hdr_write(hdr, msg_info, TYPE(FIRMWARE_REVISION), sizeof(l2tp_avp_firmware_revision_t), hide);
	avp_data->value = htons(data->value->firmware_revision.value);
	return result;
}

static int l2tp_avp_decode_firmware_revision(l2tp_avp_hdr_t *hdr,
					     l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_firmware_revision_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
...
{
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_host_name_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_host_name(l2tp_avp_hdr_t *hdr,
				     l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_vendor_name_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_vendor_name(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
				     ...
				     struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_tunnel_id_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(TUNNEL_ID), sizeof(l2tp_avp_tunnel_id_t), hide);
	avp_data->value = htons(data->value->tunnel_id.value);
	return result;
}

static int l2tp_avp_decode_tunnel_id(l2tp_avp_hdr_t *hdr,
				     l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_tunnel_id_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					  ...
					  struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_rx_window_size_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(RX_WINDOW_SIZE), sizeof(l2tp_avp_rx_window_size_t), hide);
	avp_data->value = htons(data->value->rx_window_size.value);
	return result;
}

static int l2tp_avp_decode_rx_window_size(l2tp_avp_hdr_t *hdr,
					  l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_rx_window_size_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
				     ...
				     struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_challenge_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_challenge(l2tp_avp_hdr_t *hdr,
				     l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
					   ...
					   struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_q931_cause_code_t *avp_data = (void *) &hdr->value[0];
	...
	memcpy(&avp_data->advisory_msg[0], &data->value->q931_cause_code.advisory_msg[0], data->value_len - sizeof(l2tp_avp_q931_cause_code_t));
	return result;
}

static int l2tp_avp_decode_q931_cause_code(l2tp_avp_hdr_t *hdr,
					   l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_q931_cause_code_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					      ...
					      struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_challenge_response_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(CHALLENGE_RESPONSE), sizeof(l2tp_avp_challenge_response_t), hide);
	memcpy(&avp_data->value[0], data->value->challenge_response.value, sizeof(l2tp_avp_challenge_response_t));
...
static int l2tp_avp_decode_challenge_response(l2tp_avp_hdr_t *hdr,
					      l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
				      ...
				      struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_session_id_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(SESSION_ID), sizeof(l2tp_avp_session_id_t), hide);
	avp_data->value = htons(data->value->session_id.value);
	return result;
}

static int l2tp_avp_decode_session_id(l2tp_avp_hdr_t *hdr,
				      l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_session_id_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					      ...
					      struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_call_serial_number_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(CALL_SERIAL_NUMBER), sizeof(l2tp_avp_call_serial_number_t), hide);
	avp_data->value = htonl(data->value->call_serial_number.value);
	return result;
}

static int l2tp_avp_decode_call_serial_number(l2tp_avp_hdr_t *hdr,
					      l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_call_serial_number_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_minimum_bps_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(MINIMUM_BPS), sizeof(l2tp_avp_minimum_bps_t), hide);
	avp_data->value = htonl(data->value->minimum_bps.value);
	return result;
}

static int l2tp_avp_decode_minimum_bps(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_minimum_bps_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_maximum_bps_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(MAXIMUM_BPS), sizeof(l2tp_avp_maximum_bps_t), hide);
	avp_data->value = htonl(data->value->maximum_bps.value);
	return result;
}

static int l2tp_avp_decode_maximum_bps(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_maximum_bps_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_bearer_type_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(BEARER_TYPE), sizeof(l2tp_avp_bearer_type_t), hide);
	avp_data->u.value = htonl(data->value->bearer_type.u.value);
	return result;
}

static int l2tp_avp_decode_bearer_type(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_bearer_type_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
	result->value->bearer_type.u.value = ntohl(result->value->bearer_type.u.value);
	l2tp_tunnel_log(tunnel, L2TP_AVPDATA, LOG_DEBUG, "AVPDATA: BEARER_TYPE: type=%u", result->value->bearer_type.u.value);
	return avp_len;
}
					...
					struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_framing_type_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(FRAMING_TYPE), sizeof(l2tp_avp_framing_type_t), hide);
	avp_data->u.value = htonl(data->value->framing_type.u.value);
	return result;
}

static int l2tp_avp_decode_framing_type(l2tp_avp_hdr_t *hdr,
					l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_framing_type_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
	result->value->framing_type.u.value = ntohl(result->value->framing_type.u.value);
	l2tp_tunnel_log(tunnel, L2TP_AVPDATA, LOG_DEBUG, "AVPDATA: FRAMING_TYPE: type=%u", result->value->framing_type.u.value);
	return avp_len;
}
...
static int l2tp_avp_decode_packet_proc_delay(l2tp_avp_hdr_t *hdr,
					     l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	/* Ignored. This AVP was only present in the draft RFC */
	return 0;
					 ...
					 struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_called_number_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_called_number(l2tp_avp_hdr_t *hdr,
					 l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	l2tp_avp_called_number_t *called_number = (void *) &hdr->value[0];
					  ...
					  struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_calling_number_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_calling_number(l2tp_avp_hdr_t *hdr,
					  l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
	l2tp_avp_calling_number_t *calling_number = (void *) &hdr->value[0];
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_sub_address_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_sub_address(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
	l2tp_avp_sub_address_t *sub_address = (void *) &hdr->value[0];
					    ...
					    struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_connect_speed_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(CONNECT_SPEED), sizeof(l2tp_avp_connect_speed_t), hide);
	avp_data->value = htonl(data->value->connect_speed.value);
	return result;
}

static int l2tp_avp_decode_tx_connect_speed(l2tp_avp_hdr_t *hdr,
					    l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_connect_speed_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					       ...
					       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_physical_channel_id_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(PHYSICAL_CHANNEL_ID), sizeof(l2tp_avp_physical_channel_id_t), hide);
	avp_data->value = htons(data->value->physical_channel_id.value);
	return result;
}

static int l2tp_avp_decode_physical_channel_id(l2tp_avp_hdr_t *hdr,
					       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_physical_channel_id_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					       ...
					       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_initial_rcvd_lcp_confreq_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_initial_lcp_confreq(l2tp_avp_hdr_t *hdr,
					       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
						 ...
						 struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_last_sent_lcp_confreq_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_last_sent_lcp_confreq(l2tp_avp_hdr_t *hdr,
						 l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
						 ...
						 struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_last_rcvd_lcp_confreq_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_last_rcvd_lcp_confreq(l2tp_avp_hdr_t *hdr,
						 l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
					   ...
					   struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_proxy_auth_type_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(PROXY_AUTH_TYPE), sizeof(l2tp_avp_proxy_auth_type_t), hide);
	avp_data->value = htons(data->value->proxy_auth_type.value);
	return result;
}

static int l2tp_avp_decode_proxy_auth_type(l2tp_avp_hdr_t *hdr,
					   l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_proxy_auth_type_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					   ...
					   struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_proxy_auth_name_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_proxy_auth_name(l2tp_avp_hdr_t *hdr,
					   l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
					    ...
					    struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_proxy_auth_challenge_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_proxy_auth_chall(l2tp_avp_hdr_t *hdr,
					    l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
					 ...
					 struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_proxy_auth_id_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(PROXY_AUTH_ID), sizeof(l2tp_avp_proxy_auth_id_t), hide);
	avp_data->id = data->value->proxy_auth_id.id;
	return result;
}

static int l2tp_avp_decode_proxy_auth_id(l2tp_avp_hdr_t *hdr,
					 l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
	...
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
	if (result->value_len != sizeof(l2tp_avp_proxy_auth_id_t)) {
		return -EBADMSG;
	}
					  ...
					  struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_proxy_auth_response_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_proxy_auth_rsp(l2tp_avp_hdr_t *hdr,
					  l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
				       ...
				       struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_call_errors_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(CALL_ERRORS), sizeof(l2tp_avp_call_errors_t), hide);
...
static int l2tp_avp_decode_call_errors(l2tp_avp_hdr_t *hdr,
				       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_call_errors_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
				...
				struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_accm_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(ACCM), sizeof(l2tp_avp_accm_t), hide);
	avp_data->send_accm = htonl(data->value->accm.send_accm);
	avp_data->recv_accm = htonl(data->value->accm.recv_accm);
	return result;
}

static int l2tp_avp_decode_accm(l2tp_avp_hdr_t *hdr,
				l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_accm_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
					 ...
					 struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_random_vector_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_random_vector(l2tp_avp_hdr_t *hdr,
					 l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
					 ...
					 struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_priv_group_id_t *avp_data = (void *) &hdr->value[0];
...
static int l2tp_avp_decode_priv_group_id(l2tp_avp_hdr_t *hdr,
					 l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
					    ...
					    struct l2tp_tunnel const *tunnel, int hide)
{
	int result = buffer_len;
	l2tp_avp_hdr_t *hdr = buffer;
	l2tp_avp_rx_connect_speed_t *avp_data = (void *) &hdr->value[0];

	l2tp_avp_hdr_write(hdr, msg_info, TYPE(RX_CONNECT_SPEED), sizeof(l2tp_avp_rx_connect_speed_t), hide);
//eric--	avp_data->value = htons(data->value->rx_connect_speed.value);
	avp_data->value = htonl(data->value->rx_connect_speed.value);	//eric++
	return result;
}

static int l2tp_avp_decode_rx_connect_speed(l2tp_avp_hdr_t *hdr,
					    l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);

	if (avp_len != (sizeof(l2tp_avp_rx_connect_speed_t) + L2TP_AVP_HEADER_LEN)) {
		return -EBADMSG;
	}
	result->value = (void *) &hdr->value[0];
	result->value_len = avp_len - L2TP_AVP_HEADER_LEN;
...
static int l2tp_avp_decode_sequencing_required(l2tp_avp_hdr_t *hdr,
					       l2tp_avp_desc_t *result, struct l2tp_tunnel const *tunnel)
{
	uint16_t flag_len = ntohs(hdr->flag_len);
	int avp_len = L2TP_AVP_HDR_LEN(flag_len);
...
int l2tp_avp_hidable(l2tp_avp_hdr_t *avp)
{
...
int l2tp_avp_message_decode(int msg_len, l2tp_avp_hdr_t *first_avp, l2tp_avp_desc_t *data, 
			    struct l2tp_tunnel const *tunnel)
{
	...
	l2tp_tunnel_get_secret(tunnel, (char**)&secret, &secret_len);
	...
	if (msg_type < L2TP_AVP_MSG_COUNT) {
		...
		while (len > 0) {
			...
			if (avp_flag_len & L2TP_AVP_HDR_HBIT) {
				result = l2tp_avp_unhide(avp, &unhidden_avp_len, secret, secret_len,
...
int l2tp_avp_message_encode(uint16_t msg_type, struct l2tp_packet **ppkt, int hide, 
			    l2tp_avp_desc_t *avp_data, struct l2tp_tunnel *tunnel)
{
	int num_avps = 0;
	void *buffer = NULL;
	int buffer_len = 0;
 ...
 * message fully.
 */
int l2tp_avp_preparse(l2tp_avp_hdr_t *first_avp, int avp_data_len, char **host_name, uint16_t *msg_type)
{
	l2tp_avp_message_type_t *msg_type_avp = NULL;
	l2tp_avp_host_name_t *host_name_avp = NULL;
