...
{
	return (l2tp_tunnel_delete_1_svc(argp->tunnel_id, argp->tunnel_name, result, rqstp));
}
...
{
	return (l2tp_session_delete_1_svc(argp->tunnel_id, argp->tunnel_name, argp->session_id, argp->session_name, result, rqstp));
}
...
int
_l2tp_session_incall_ind_1 (l2tp_session_incall_ind_1_argument *argp, void *result, struct svc_req *rqstp)
{
	return (l2tp_session_incall_ind_1_svc(argp->ppp_unit, argp->params, argp->tunnel_profile_name, result, rqstp));
}
...
l2tp_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		...
		l2tp_session_incall_ind_1_argument l2tp_session_incall_ind_1_arg;
	...
	case L2TP_SESSION_INCALL_IND:
		_xdr_argument = (xdrproc_t) xdr_l2tp_session_incall_ind_1_argument;
		_xdr_result = (xdrproc_t) xdr_int;
