...
xdr_l2tp_api_ppp_profile_msg_data (XDR *xdrs, l2tp_api_ppp_profile_msg_data *objp)
{
	...
	if (xdrs->x_op == XDR_ENCODE) {
		 ...
		 if (!xdr_uint16_t (xdrs, &objp->mtu))
			 return FALSE;
		 if (!xdr_uint32_t (xdrs, &objp->auth_flags))
			 return FALSE;
...
bool_t
xdr_l2tp_session_incall_ind_1_argument (XDR *xdrs, l2tp_session_incall_ind_1_argument *objp)
{
	 if (!xdr_int (xdrs, &objp->ppp_unit))
		 return FALSE;
	 if (!xdr_l2tp_api_session_msg_data (xdrs, &objp->params))
		 return FALSE;
