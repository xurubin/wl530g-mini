...
#ifdef EMBED
#define DEFAULT_AUTH_FILE "/tmp/l2tp/l2tp-secrets"
#define DEFAULT_CONFIG_FILE "/tmp/l2tpd.conf"
#else
#define DEFAULT_AUTH_FILE "/tmp/l2tp-secrets"
#define DEFAULT_CONFIG_FILE "/tmp/l2tpd.conf"
#endif
...
struct lns
{
    ...
    char server_name[STRLEN];	/* Link to Server Name*/
};
