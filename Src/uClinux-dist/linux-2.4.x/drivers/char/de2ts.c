 ...
 * by configuring the signal as an regular IO signal, then it queue
...
struct file_operations de2ts_fops = {
	owner:THIS_MODULE,
	poll:de2ts_poll,
	read:de2ts_read,
	ioctl:de2ts_ioctl,
