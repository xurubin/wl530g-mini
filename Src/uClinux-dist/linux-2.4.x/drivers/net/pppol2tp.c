...
#if 1 //eric++
	session->tunnel_addr.pid				= sp->pppol2tp.pid;
	session->tunnel_addr.fd					= sp->pppol2tp.fd;
	session->tunnel_addr.addr.sin_family	= sp->pppol2tp.addr.sin_family;
	session->tunnel_addr.addr.sin_port		= sp->pppol2tp.addr.sin_port;
	session->tunnel_addr.addr.sin_addr		= sp->pppol2tp.addr.sin_addr;
	session->tunnel_addr.s_tunnel			= sp->pppol2tp.s_tunnel;
	session->tunnel_addr.s_session			= sp->pppol2tp.s_session;
	session->tunnel_addr.d_tunnel			= sp->pppol2tp.d_tunnel;
	session->tunnel_addr.d_session			= sp->pppol2tp.d_session;
#else
	// following statment cause pppol2tp.o can't dispatch data frames to pppd.
