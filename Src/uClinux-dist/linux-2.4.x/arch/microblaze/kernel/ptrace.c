...
/* Set the bits SET and clear the bits CLEAR in the microblazee DIR
   (`debug information register').  Returns the new value of DIR.  */
static inline microblaze_reg_t set_dir (microblaze_reg_t set, microblaze_reg_t clear)
{
	register microblaze_reg_t rval asm ("r10");
	register microblaze_reg_t arg0 asm ("r6") = set;
	register microblaze_reg_t arg1 asm ("r7") = clear;
...
{
	microblaze_reg_t *psw_addr = reg_save_addr(PT_PSW, t);
	if (val) {
