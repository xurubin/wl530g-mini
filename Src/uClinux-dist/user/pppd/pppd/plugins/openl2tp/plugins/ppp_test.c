...
static int ppp_test_close(struct ppp_context *ppp, __u16 tunnel_id, __u16 session_id);

/* Used to record previous value of hook so that we can chain them */
static int (*ppp_test_old_session_created_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
static int (*ppp_test_old_session_deleted_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
static int (*ppp_test_old_session_modified_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
static int (*ppp_test_old_session_up_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id, __u16 peer_tunnel_id, __u16 peer_session_id);
static int (*ppp_test_old_session_down_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
...
static struct ppp_context *ppp_test_find_by_id(__u16 tunnel_id, __u16 session_id)
{
...
static int ppp_test_create(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
...
static int ppp_test_session_created(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
...
static int ppp_test_session_deleted(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
...
static int ppp_test_session_modified(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
...
static int ppp_test_session_up(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id, __u16 peer_tunnel_id, __u16 peer_session_id)
{
	struct ppp_context *ppp;
	int result = 0;
...
static int ppp_test_session_down(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
...
const char l2tp_plugin_version[] = "V0.1";
