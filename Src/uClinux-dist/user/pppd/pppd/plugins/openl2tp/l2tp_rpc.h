...
#define L2TP_APP_COPYRIGHT_INFO "(c) Copyright 2004"
#define L2TP_APP_VENDOR_INFO "Katalix Systems Ltd."
#define L2TP_APP_MAJOR_VERSION 0
...
#define L2TP_API_TUNNEL_PROFILE_DEFAULT_FRAMING_CAP_ASYNC 0
#define L2TP_API_TUNNEL_PROFILE_DEFAULT_BEARER_CAP_DIGITAL 1
#define L2TP_API_TUNNEL_PROFILE_DEFAULT_BEARER_CAP_ANALOG 0
...
#define L2TP_API_SESSION_PROFILE_DEFAULT_SESSION_TX_CONNECT_SPEED 0
...
#define L2TP_API_PPP_PROFILE_FLAG_AUTH_FLAGS 128
...
#define L2TP_API_PPP_AUTH_NONE 1
#define L2TP_API_PPP_AUTH_REFUSE_EAP 2
#define L2TP_API_PPP_AUTH_REFUSE_MSCHAPV2 4
#define L2TP_API_PPP_AUTH_REFUSE_MSCHAP 8
#define L2TP_API_PPP_AUTH_REFUSE_CHAP 16
#define L2TP_API_PPP_AUTH_REFUSE_PAP 32
...
#define L2TP_API_PPP_PROFILE_DEFAULT_AUTH_FLAGS 0
...
struct l2tp_session_incall_ind_1_argument {
	int ppp_unit;
	struct l2tp_api_session_msg_data params;
	char *tunnel_profile_name;
};
typedef struct l2tp_session_incall_ind_1_argument l2tp_session_incall_ind_1_argument;
...
extern  enum clnt_stat l2tp_tunnel_delete_1(uint16_t , optstring , int *, CLIENT *);
extern  bool_t l2tp_tunnel_delete_1_svc(uint16_t , optstring , int *, struct svc_req *);
...
extern  enum clnt_stat l2tp_session_delete_1(uint16_t , optstring , uint16_t , optstring , int *, CLIENT *);
extern  bool_t l2tp_session_delete_1_svc(uint16_t , optstring , uint16_t , optstring , int *, struct svc_req *);
...
extern  enum clnt_stat l2tp_session_incall_ind_1(int , struct l2tp_api_session_msg_data , char *, int *, CLIENT *);
extern  bool_t l2tp_session_incall_ind_1_svc(int , struct l2tp_api_session_msg_data , char *, int *, struct svc_req *);
...
extern  bool_t xdr_l2tp_session_incall_ind_1_argument (XDR *, l2tp_session_incall_ind_1_argument*);
...
extern bool_t xdr_l2tp_session_incall_ind_1_argument ();
