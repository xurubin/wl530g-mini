...
const L2TP_APP_COPYRIGHT_INFO		= "(c) Copyright 2004";
const L2TP_APP_VENDOR_INFO		= "Katalix Systems Ltd.";
const L2TP_APP_MAJOR_VERSION		= 0;
const L2TP_APP_MINOR_VERSION		= 8;
...
const L2TP_API_TUNNEL_PROFILE_DEFAULT_FRAMING_CAP_ASYNC		= 0;
const L2TP_API_TUNNEL_PROFILE_DEFAULT_BEARER_CAP_DIGITAL	= 1;
const L2TP_API_TUNNEL_PROFILE_DEFAULT_BEARER_CAP_ANALOG		= 0;
...
program L2TP_PROG {
	version L2TP_VERSION {
		...
		int L2TP_SESSION_INCALL_IND(int ppp_unit, struct l2tp_api_session_msg_data params, string tunnel_profile_name) = 24;
...
} = 0x206b6c78;			/* choose a number that is unlikely to be already used */
