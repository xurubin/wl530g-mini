...
static int ppp_unix_pppd_terminate(struct ppp_context *ppp, __u16 tunnel_id, __u16 session_id);

/* Used to record previous value of hook so that we can chain them */
static int (*ppp_unix_old_session_created_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
static int (*ppp_unix_old_session_deleted_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
static int (*ppp_unix_old_session_modified_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
static int (*ppp_unix_old_session_up_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id, __u16 peer_tunnel_id, __u16 peer_session_id);
static int (*ppp_unix_old_session_down_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id);
static int (*ppp_unix_old_session_get_stats_hook)(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id, struct pppol2tp_ioc_stats *stats);
...
static int ppp_unix_socket_connect(int session_fd, int tunnel_fd, struct sockaddr_in const *addr, 
				   __u16 tunnel_id, __u16 session_id, __u16 peer_tunnel_id, __u16 peer_session_id)
{
...
static struct ppp_context *ppp_unix_find_by_id(__u16 tunnel_id, __u16 session_id)
{
...
static int ppp_unix_pppd_spawn(struct ppp_context *ppp)
{
	...
	if (pid == 0) { 
		...
		l2tp_session_log(ppp->session, L2TP_DATA, LOG_DEBUG, "sess %hu/%hu: %s %s %s %s %s %s %s %s %s %s %s %s"
				 " %s %s %s %s %s %s %s %s"
				 ...
				 argv[15] ? argv[15] : "", argv[15] ? argv[15] : "", argv[16] ? argv[16] : "", 
				 argv[17] ? argv[17] : "", argv[18] ? argv[18] : "", argv[19] ? argv[19] : "", 
				 argv[20] ? argv[20] : "", argv[21] ? argv[21] : "", argv[22] ? argv[22] : "", 
				 argv[23] ? argv[23] : "", argv[24] ? argv[24] : "", argv[25] ? argv[25] : "", 
				 argv[26] ? argv[26] : "", argv[27] ? argv[27] : "", argv[28] ? argv[28] : "", 
				 argv[29] ? argv[29] : "", argv[30] ? argv[30] : "", argv[31] ? argv[31] : "", 
				 argv[32] ? argv[32] : "", argv[33] ? argv[33] : "", argv[34] ? argv[34] : "", 
				 argv[35] ? argv[35] : "", argv[36] ? argv[36] : "", argv[37] ? argv[37] : "", 
				 argv[38] ? argv[38] : "", argv[39] ? argv[39] : "", argv[40] ? argv[40] : "", 
				 argv[41] ? argv[41] : "", argv[42] ? argv[42] : "", argv[43] ? argv[43] : "", 
				 argv[44] ? argv[44] : "", argv[45] ? argv[45] : "", argv[46] ? argv[46] : "", 
				 argv[47] ? argv[47] : "", argv[48] ? argv[48] : "", argv[49] ? argv[49] : "", 
				 argv[50] ? argv[50] : "", argv[51] ? argv[51] : "", argv[52] ? argv[52] : "", 
				 argv[53] ? argv[53] : "", argv[54] ? argv[54] : "", argv[55] ? argv[55] : "", 
				 argv[56] ? argv[56] : "", argv[57] ? argv[57] : "", argv[58] ? argv[58] : "", 
				 argv[59] ? argv[59] : "", argv[60] ? "..." : "");
...
static int ppp_unix_create(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
...
static int ppp_unix_session_created(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
...
static int ppp_unix_session_deleted(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
...
static int ppp_unix_session_modified(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
	struct ppp_context *ppp;
	int mtu;
...
static int ppp_unix_session_up(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id, __u16 peer_tunnel_id, __u16 peer_session_id)
{
	struct ppp_context *ppp;
	int result = 0;
...
static int ppp_unix_session_down(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id)
{
	int result = 0;
...
static int ppp_unix_session_get_stats(struct l2tp_session const *session, __u16 tunnel_id, __u16 session_id, struct pppol2tp_ioc_stats *stats)
{
	struct ppp_context *ppp;
	int result = 0;
...
const char l2tp_plugin_version[] = "V0.2";
