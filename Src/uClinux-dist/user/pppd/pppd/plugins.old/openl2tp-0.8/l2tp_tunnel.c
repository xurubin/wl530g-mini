...
bool_t l2tp_tunnel_get_1_svc(u_short tunnel_id, optstring tunnel_name, struct l2tp_api_tunnel_msg_data *result, struct svc_req *req)
{
	...
	result->peer.framing_cap_sync = tunnel->peer.framing_cap.sync;
	result->peer.framing_cap_async = tunnel->peer.framing_cap.async;
	result->peer.bearer_cap_digital = tunnel->peer.bearer_cap.digital;
	result->peer.bearer_cap_analog = tunnel->peer.bearer_cap.analog;
