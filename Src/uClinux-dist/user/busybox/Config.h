...
//
// Support module load map output to stdout
#define BB_FEATURE_INSMOD_LOAD_MAP
//
// Support module load map with full symbols
#define BB_FEATURE_INSMOD_LOAD_MAP_FULL
//
