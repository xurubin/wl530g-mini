...
#define NVRAM_CONFIG_MTD "/dev/mtd2"
#define NVRAM_CONFIG_MTDBLOCK "/dev/mtdblock2"
#define NVRAM_TEMPLATE 1
#define NVRAM_TEMPLATE_MTD "/dev/mtd3"
#define NVRAM_TEMPLATE_MTDBLOCK "/dev/mtdblock3"
